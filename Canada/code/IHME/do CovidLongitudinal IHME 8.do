...
log using "log CovidVisualizedCountry IHME 8.smcl", replace
...
save "CovidVisualizedCountry IHME DayDea 2 Manitoba.dta", replace

keep if provincestate == "Manitoba"

drop *XXX *XAB *XBC *XNB *XNL *XNT *XNS *XNU *XON *XPE *XQC *XSK // extra for this do file
...
label var DDPerErrA02XMB`update'_Med1 "DayDeaMeSmA02S01XMB`update' median percent error by epi weeks and updates"

bysort epi_yrwk : egen DDAbPeErA02XMB`update'_Med1 = median(DDAbPeErA02XMB`update')
label var DDAbPeErA02XMB`update'_Med1 "DayDeaMeSmA02S01XMB`update' median absolute percent error by epi weeks and updates" 
...
label var DDPerErrA02XMB_Mean1 "DayDeaMeSmA02S01XMB mean over updates of median percent error by epi weeks"

egen DDAbPeErA02XMB_Mean1 = rowmean(DDAbPeErA02XMB20200422_Med1-DDAbPeErA02XMB20211221_Med1) 
label var DDAbPeErA02XMB_Mean1 "DayDeaMeSmA02S01XMB mean over updates of median absolute percent error by epi weeks"
...
label var DDAbPeErA02XMB_Mean2 "DayDeaMeSmA02S01XMB Mean over epi weeks of median absolute percent error over updates"
...
save "CovidVisualizedCountry IHME DayDea 3 Manitoba.dta", replace
...
qui graph export "graph 7 Manitoba C-19 daily deaths error, $country, IHME, Error Mean1.pdf", replace
...
qui graph export "graph 8 Manitoba C-19 daily deaths error, $country, IHME, Absolute Error Mean1.pdf", replace
...
***************************************************************
* 9 Daily deaths, Manitoba, mean over updates of median percent error by epi weeks
...
qui graph export "graph 9 Manitoba C-19 daily deaths error, $country, IHME, Percent Error Mean1.pdf", replace
...
***************************************************************
* 10 Daily deaths, Manitoba, mean over updates of median absolute percent error by epi weeks
...
qui graph export "graph 10 Manitoba C-19 daily deaths error, $country, IHME, Absolute Percent Error Mean1.pdf", replace
...
view "log CovidVisualizedCountry IHME 8.smcl"
