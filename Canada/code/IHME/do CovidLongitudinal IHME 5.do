...
use "CovidLongitudinal IHME 3.dta"
...
ytitle(Daily deaths error measure) title("C19 daily deaths error by epi weeks and model updates", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) ///
subtitle("$country, National, IHME, Forecast only", size(small)) 
 
qui graph export "graph 3 National C19 daily deaths error, $country, IHME, all updates.pdf", replace
...
ytitle(Daily deaths error measure) title("C19 daily deaths error by epi weeks and model updates", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) ///
subtitle("$country, Alberta, IHME, Forecast only", size(small)) 
 
qui graph export "graph 3 Alberta C19 daily deaths error, $country, IHME, all updates.pdf", replace
...
ytitle(Daily deaths error measure) title("C19 daily deaths error by epi weeks and model updates", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) ///
subtitle("$country, British Columbia, IHME, Forecast only", size(small)) 
 
qui graph export "graph 3 British Columbia C19 daily deaths error, $country, IHME, all updates.pdf", replace
...
ytitle(Daily deaths error measure) title("C19 daily deaths error by epi weeks and model updates", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) ///
subtitle("$country, Manitoba, IHME, Forecast only", size(small)) 
 
qui graph export "graph 3 Manitoba C19 daily deaths error, $country, IHME, all updates.pdf", replace
...
ytitle(Daily deaths error measure) title("C19 daily deaths error by epi weeks and model updates", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) ///
subtitle("$country, Nova Scotia, IHME, Forecast only", size(small)) 
 
qui graph export "graph 3 Nova Scotia C19 daily deaths error, $country, IHME, all updates.pdf", replace
...
ytitle(Daily deaths error measure) title("C19 daily deaths error by epi weeks and model updates", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) ///
subtitle("$country, Ontario, IHME, Forecast only", size(small)) 
 
qui graph export "graph 3 Ontario C19 daily deaths error, $country, IHME, all updates.pdf", replace
...
ytitle(Daily deaths error measure) title("C19 daily deaths error by epi weeks and model updates", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) ///
subtitle("$country, Quebec, IHME, Forecast only", size(small)) 
 
qui graph export "graph 3 Quebec C19 daily deaths error, $country, IHME, all updates.pdf", replace
...
ytitle(Daily deaths error measure) title("C19 daily deaths error by epi weeks and model updates", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) ///
subtitle("$country, Saskatchewan, IHME, Forecast only", size(small)) 
 
qui graph export "graph 3 Saskatchewan C19 daily deaths error, $country, IHME, all updates.pdf", replace
...
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
ytitle(Daily deaths error measure) title("C19 daily deaths absolute error by epi weeks and model updates", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) ///
subtitle("$country, National, IHME, Forecast only", size(small))  
 
qui graph export "graph 4 National C19 daily deaths absolute error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 4 Alberta C19 daily deaths absolute error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 4 British Columbia C19 daily deaths absolute error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 4 Manitoba C19 daily deaths absolute error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 4 Nova Scotia C19 daily deaths absolute error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 4 Ontario C19 daily deaths absolute error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 4 Quebec C19 daily deaths absolute error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 4 Saskatchewan C19 daily deaths absolute error, $country, IHME, all updates.pdf", replace
...
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
ytitle(Daily deaths error measure) title("C19 daily deaths percent error by epi weeks and model updates", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) ///
subtitle("$country, National, IHME, Forecast only", size(small))       
 
qui graph export "graph 5 National C19 daily deaths percent error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 5 Alberta C19 daily deaths percent error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 5 British Columbia C19 daily deaths percent error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 5 Manitoba C19 daily deaths percent error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 5 Nova Scotia C19 daily deaths percent error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 5 Ontario C19 daily deaths percent error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 5 Quebec C19 daily deaths percent error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 5 Saskatchewan C19 daily deaths percent error, $country, IHME, all updates.pdf", replace
...
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
ytitle(Daily deaths error measure) title("C19 daily deaths absolute percent error by epi weeks and model updates", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) ///
subtitle("$country, National, IHME, Forecast only", size(small))        
 
qui graph export "graph 6 National C19 daily deaths absolute percent error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 6 Alberta C19 daily deaths absolute percent error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 6 British Columbia C19 daily deaths absolute percent error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 6 Manitoba C19 daily deaths absolute percent error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 6 Nova Scotia C19 daily deaths absolute percent error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 6 Ontario C19 daily deaths absolute percent error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 6 Quebec C19 daily deaths absolute percent error, $country, IHME, all updates.pdf", replace
...
qui graph export "graph 6 Saskatchewan C19 daily deaths absolute percent error, $country, IHME, all updates.pdf", replace
