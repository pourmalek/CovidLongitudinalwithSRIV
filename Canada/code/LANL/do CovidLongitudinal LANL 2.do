...
log using "log CovidVisualizedCountry LANL 2.smcl", replace
...
use "CovidLongitudinal LANL 20200426.dta", clear

foreach update of local list {

	append using "CovidLongitudinal LANL `update'.dta"
...
view "log CovidVisualizedCountry LANL 2.smcl"
