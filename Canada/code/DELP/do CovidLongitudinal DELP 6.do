...
ytitle(Daily deaths error measure) title("C19 daily deaths error by epi weeks and model updates", size(medsmall)) /// 
...
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%15.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths error measure) title("C19 daily deaths absolute error by epi weeks and model updates", size(medsmall)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) ///
subtitle("$country, National, DELP, Forecast only", size(small)) 
...
* 110 4 Daily deaths, National, % Error
...
qui graph export "graph 110 04 C19 daily deaths, $country, National, DELP, % Error.pdf", replace
...
* 110 5 Daily deaths, National, absolute % Error
...
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%15.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths error measure) title("C19 daily deaths absolute % error by epi weeks & model updates", size(medsmall)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) ///
subtitle("$country, National, DELP, Forecast only", size(small)) 

qui graph export "graph 110 05 C19 daily deaths, $country, National, DELP, absolute % Error.pdf", replace
...
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%15.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths error measure) title("C19 daily deaths, median error by epi weeks and updates", size(medsmall)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) ///
subtitle("$country, National, DELP, Forecast only", size(small)) 
...
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%15.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths error measure) title("C19 daily deaths, mean over updates of median error by epi weeks", size(medsmall)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) ///
subtitle("$country, National, DELP, Forecast only", size(small))  
...
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%15.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths error measure) title("C19 daily deaths, median absolute error by epi weeks and updates", size(medsmall)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) ///
subtitle("$country, National, DELP, Forecast only", size(small)) 
...
qui graph export "graph 110 09 C19 daily deaths, $country, National, DELP, Absolute Error Mean1.pdf", replace
...
* 110 11 Daily deaths, National, mean over updates of median % error by epi weeks
...
xlabel(, angle(forty_five)) ylabel(, format(%15.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
yscale(titlegap(2)) ytitle(Daily deaths error measure) ///
title("C19 daily deaths, mean over updates of median % error by epi weeks", size(medsmall)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) ///
subtitle("$country, National, DELP, Forecast only", size(small))
...
* 110 13 Daily deaths, National, mean over updates of median absolute % error by epi weeks
...
xlabel(, angle(forty_five)) ylabel(, format(%15.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
yscale(titlegap(2)) ytitle(Daily deaths error measure) ///
title("C19 daily deaths, mean over updates of median absolute % error by epiweeks", size(medsmall)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) ///
subtitle("$country, National, DELP, Forecast only", size(small)) 
...
* 111 4 Daily deaths, Alberta, % Error
...
qui graph export "graph 111 04 C19 daily deaths, $country, Alberta, DELP, % Error.pdf", replace
...
* 111 5 Daily deaths, Alberta, absolute % Error
...
qui graph export "graph 111 05 C19 daily deaths, $country, Alberta, DELP, absolute % Error.pdf", replace
...
qui graph export "graph 111 10 C19 daily deaths, $country, Alberta, DELP, % Error median1.pdf", replace
...
* 111 11 Daily deaths, Alberta, mean over updates of median % error by epi weeks
...
qui graph export "graph 111 11 C19 daily deaths, $country, Alberta, DELP, % Error Mean1.pdf", replace
...
qui graph export "graph 111 12 C19 daily deaths, $country, Alberta, DELP, absolute % Error median1.pdf", replace
...
* 111 13 Daily deaths, Alberta, mean over updates of median absolute % error by epi weeks
...
qui graph export "graph 111 13 C19 daily deaths, $country, Alberta, DELP, absolute % Error Mean1.pdf", replace
...
* 112 4 Daily deaths, British Columbia, % Error
...
qui graph export "graph 112 04 C19 daily deaths, $country, British Columbia, DELP, % Error.pdf", replace
...
* 112 5 Daily deaths, British Columbia, absolute % Error
...
qui graph export "graph 112 05 C19 daily deaths, $country, British Columbia, DELP, absolute % Error.pdf", replace
...
qui graph export "graph 112 10 C19 daily deaths, $country, British Columbia, DELP, % Error median1.pdf", replace
...
* 112 11 Daily deaths, British Columbia, mean over updates of median % error by epi weeks
...
qui graph export "graph 112 11 C19 daily deaths, $country, British Columbia, DELP, % Error Mean1.pdf", replace
...
qui graph export "graph 112 12 C19 daily deaths, $country, British Columbia, DELP, absolute % Error median1.pdf", replace
...
* 112 13 Daily deaths, British Columbia, mean over updates of median absolute % error by epi weeks
...
qui graph export "graph 112 13 C19 daily deaths, $country, British Columbia, DELP, absolute % Error Mean1.pdf", replace
...
* 113 4 Daily deaths, Manitoba, % Error
...
qui graph export "graph 113 04 C19 daily deaths, $country, Manitoba, DELP, % Error.pdf", replace
...
* 113 5 Daily deaths, Manitoba, absolute % Error
...
qui graph export "graph 113 05 C19 daily deaths, $country, Manitoba, DELP, absolute % Error.pdf", replace
...
qui graph export "graph 113 10 C19 daily deaths, $country, Manitoba, DELP, % Error median1.pdf", replace
...
* 113 11 Daily deaths, Manitoba, mean over updates of median % error by epi weeks
...
qui graph export "graph 113 11 C19 daily deaths, $country, Manitoba, DELP, % Error Mean1.pdf", replace
...
qui graph export "graph 113 12 C19 daily deaths, $country, Manitoba, DELP, absolute % Error median1.pdf", replace
...
* 113 13 Daily deaths, Manitoba, mean over updates of median absolute % error by epi weeks
...
qui graph export "graph 113 13 C19 daily deaths, $country, Manitoba, DELP, absolute % Error Mean1.pdf", replace
...
* 114 4 Daily deaths, New Brunswick, % Error
...
qui graph export "graph 114 04 C19 daily deaths, $country, New Brunswick, DELP, % Error.pdf", replace
...
* 114 5 Daily deaths, New Brunswick, absolute % Error
...
qui graph export "graph 114 05 C19 daily deaths, $country, New Brunswick, DELP, absolute % Error.pdf", replace
...
qui graph export "graph 114 10 C19 daily deaths, $country, New Brunswick, DELP, % Error median1.pdf", replace
...
* 114 11 Daily deaths, New Brunswick, mean over updates of median % error by epi weeks
...
qui graph export "graph 114 11 C19 daily deaths, $country, New Brunswick, DELP, % Error Mean1.pdf", replace
...
qui graph export "graph 114 12 C19 daily deaths, $country, New Brunswick, DELP, absolute % Error median1.pdf", replace
...
* 114 13 Daily deaths, New Brunswick, mean over updates of median absolute % error by epi weeks
...
qui graph export "graph 114 13 C19 daily deaths, $country, New Brunswick, DELP, absolute % Error Mean1.pdf", replace
...
* 115 4 Daily deaths, Newfoundland & Labrador, % Error
...
qui graph export "graph 115 04 C19 daily deaths, $country, Newfoundland & Labrador, DELP, % Error.pdf", replace
...
* 115 5 Daily deaths, Newfoundland & Labrador, absolute % Error
...
qui graph export "graph 115 05 C19 daily deaths, $country, Newfoundland & Labrador, DELP, absolute % Error.pdf", replace
...
* 115 11 Daily deaths, Newfoundland & Labrador, mean over updates of median % error by epi weeks
...
qui graph export "graph 115 11 C19 daily deaths, $country, Newfoundland & Labrador, DELP, % Error Mean1.pdf", replace
...
qui graph export "graph 115 12 C19 daily deaths, $country, Newfoundland & Labrador, DELP, absolute % Error median1.pdf", replace
...
* 115 13 Daily deaths, Newfoundland & Labrador, mean over updates of median absolute % error by epi weeks
...
qui graph export "graph 115 13 C19 daily deaths, $country, Newfoundland & Labrador, DELP, absolute % Error Mean1.pdf", replace
...
* 116 4 Daily deaths, Nova Scotia, % Error
...
qui graph export "graph 116 04 C19 daily deaths, $country, Nova Scotia, DELP, % Error.pdf", replace
...
* 116 5 Daily deaths, Nova Scotia, absolute % Error
...
qui graph export "graph 116 05 C19 daily deaths, $country, Nova Scotia, DELP, absolute % Error.pdf", replace
...
qui graph export "graph 116 10 C19 daily deaths, $country, Nova Scotia, DELP, % Error median1.pdf", replace
...
* 116 11 Daily deaths, Nova Scotia, mean over updates of median % error by epi weeks
...
qui graph export "graph 116 11 C19 daily deaths, $country, Nova Scotia, DELP, % Error Mean1.pdf", replace
...
qui graph export "graph 116 12 C19 daily deaths, $country, Nova Scotia, DELP, absolute % Error median1.pdf", replace
...
* 116 13 Daily deaths, Nova Scotia, mean over updates of median absolute % error by epi weeks
...
qui graph export "graph 116 13 C19 daily deaths, $country, Nova Scotia, DELP, absolute % Error Mean1.pdf", replace
...
* 117 4 Daily deaths, Ontario, % Error
...
qui graph export "graph 117 04 C19 daily deaths, $country, Ontario, DELP, % Error.pdf", replace
...
* 117 5 Daily deaths, Ontario, absolute % Error
...
qui graph export "graph 117 05 C19 daily deaths, $country, Ontario, DELP, absolute % Error.pdf", replace
...
qui graph export "graph 117 10 C19 daily deaths, $country, Ontario, DELP, % Error median1.pdf", replace
...
* 117 11 Daily deaths, Ontario, mean over updates of median % error by epi weeks
...
qui graph export "graph 117 11 C19 daily deaths, $country, Ontario, DELP, % Error Mean1.pdf", replace
...
qui graph export "graph 117 12 C19 daily deaths, $country, Ontario, DELP, absolute % Error median1.pdf", replace
...
* 117 13 Daily deaths, Ontario, mean over updates of median absolute % error by epi weeks
...
qui graph export "graph 117 13 C19 daily deaths, $country, Ontario, DELP, absolute % Error Mean1.pdf", replace
...
* 118 4 Daily deaths, Quebec, % Error
...
qui graph export "graph 118 04 C19 daily deaths, $country, Quebec, DELP, % Error.pdf", replace
...
* 118 5 Daily deaths, Quebec, absolute % Error
...
qui graph export "graph 118 05 C19 daily deaths, $country, Quebec, DELP, absolute % Error.pdf", replace
...
qui graph export "graph 118 10 C19 daily deaths, $country, Quebec, DELP, % Error median1.pdf", replace
...
* 118 11 Daily deaths, Quebec, mean over updates of median % error by epi weeks
...
qui graph export "graph 118 11 C19 daily deaths, $country, Quebec, DELP, % Error Mean1.pdf", replace
...
qui graph export "graph 118 12 C19 daily deaths, $country, Quebec, DELP, absolute % Error median1.pdf", replace
...
* 118 13 Daily deaths, Quebec, mean over updates of median absolute % error by epi weeks
...
qui graph export "graph 118 13 C19 daily deaths, $country, Quebec, DELP, absolute % Error Mean1.pdf", replace
...
* 119 4 Daily deaths, Saskatchewan, % Error
...
qui graph export "graph 119 04 C19 daily deaths, $country, Saskatchewan, DELP, % Error.pdf", replace
...
* 119 5 Daily deaths, Saskatchewan, absolute % Error
...
qui graph export "graph 119 05 C19 daily deaths, $country, Saskatchewan, DELP, absolute % Error.pdf", replace
...
qui graph export "graph 119 10 C19 daily deaths, $country, Saskatchewan, DELP, % Error median1.pdf", replace
...
* 119 11 Daily deaths, Saskatchewan, mean over updates of median % error by epi weeks
...
qui graph export "graph 119 11 C19 daily deaths, $country, Saskatchewan, DELP, % Error Mean1.pdf", replace
...
qui graph export "graph 119 12 C19 daily deaths, $country, Saskatchewan, DELP, absolute % Error median1.pdf", replace
...
* 119 13 Daily deaths, Saskatchewan, mean over updates of median absolute % error by epi weeks
...
qui graph export "graph 119 13 C19 daily deaths, $country, Saskatchewan, DELP, absolute % Error Mean1.pdf", replace
...
* 120 1 1 Daily deaths, provinces together, mean over updates of median absolute % error by epi weeks
...
qui graph export "graph 120 1 1 C19 daily deaths, $country, provinces together, DELP, absolute % Error Mean1.pdf", replace
...
* 120 1 2 Daily deaths, provinces together, mean over updates of median absolute % error by epi weeks
* w/o extremes NL NS
...
title("C19 daily deaths, mean over updates of median absolute % error by epiweeks", size(medsmall)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
subtitle("$country, provinces together, DELP, Forecast only, without extremes NL NS", size(small)) /// 
legend(order(1 "CAN" 2 "AB" 3 "BC" 4 "MB" 5 "NB" 6 "ON" 7 "QC" 8 "SK") rows(2) size(small))  

qui graph export "graph 120 1 2 C19 daily deaths, $country, provinces together, DELP, absolute % Error Mean1.pdf", replace
...
* 120 1 3 Daily deaths, provinces together, mean over updates of median absolute % error by epi weeks
* w/o extremes NL NS NB SK
...
(line DDAbPeErA01XBC_Mean1 date, sort lwidth(medium) lcolor(blue)) /// 3 "BC" blue
(line DDAbPeErA01XMB_Mean1 date, sort lwidth(medium) lcolor(lime)) /// 4 "MB" lime
(line DDAbPeErA01XON_Mean1 date, sort lwidth(medium) lcolor(red)) /// 5 "ON" red
(line DDAbPeErA01XQC_Mean1 date, sort lwidth(medium) lcolor(black)) /// 6 "QC" black
if date >= td(01jan2020) & date <= td(01mar2022) ///
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%15.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
yscale(titlegap(2)) ytitle(Daily deaths error measure) ///
title("C19 daily deaths, mean over updates of median absolute % error by epiweeks", size(medsmall)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
subtitle("$country, provinces together, DELP, Forecast only, without extremes NL NS NB SK", size(small)) /// 
legend(order(1 "CAN" 2 "AB" 3 "BC" 4 "MB" 5 "ON" 6 "QC") rows(1) size(small))  

qui graph export "graph 120 1 3 C19 daily deaths, $country, provinces together, DELP, absolute % Error Mean1.pdf", replace
...
* 130 1 1 Daily deaths, provinces together, Avergae of MAPE over updates and epi weeks
...
qui graph export "graph 130 1 1 C19 daily deaths, $country, provinces together, DELP, Average MAPE.pdf", replace
...
* 130 1 2 Daily deaths, provinces together, Avergae of MAPE over updates and epi weeks
...
qui graph export "graph 130 1 2 C19 daily deaths, $country, provinces together, DELP, Average MAPE.pdf", replace
