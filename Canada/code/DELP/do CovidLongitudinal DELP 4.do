...
di "summ DayCasMeSmA01S00XXX`update' if date == update_date"
...
di "DayCasMeSmA01S00XAB`update' if date == update_date"
...
di "DayCasMeSmA01S00XBC`update' if date == update_date"
...
di "summ DayCasMeSmA01S00XMB`update' if date == update_date"
...
di "summ DayCasMeSmA01S00XNB`update' if date == update_date"
...
di "DayCasMeSmA01S00XNL`update' if date == update_date"
...
di "DayCasMeSmA01S00XNS`update' if date == update_date"
...
di "summ DayCasMeSmA01S00XON`update' if date == update_date"
...
di "summ DayCasMeSmA01S00XQC`update' if date == update_date"
...
di "summ DayCasMeSmA01S00XSK`update' if date == update_date"
...
save "CovidLongitudinal DELP daily cases.dta", replace
