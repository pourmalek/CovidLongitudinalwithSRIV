...
foreach XYZ in XAB XBC XMB XXX XNB XNL XNS XON XQC XSK {
	...
	foreach update of local list {
		...
		qui gen DayDeaMeSmA01S00`XYZ'`update' = DayDeaMeSmA01S00`update'
		
		qui label var DayDeaMeSmA01S00`XYZ'`update' "DayDeaMeSmA01S00`XYZ'`update'"
...
foreach update of local list {
	...
	replace DayDeaMeSmA01S00XAB`update' = . if provincestate != "Alberta"
	replace DayDeaMeSmA01S00XBC`update' = . if provincestate != "British Columbia"
	replace DayDeaMeSmA01S00XMB`update' = . if provincestate != "Manitoba"
	replace DayDeaMeSmA01S00XXX`update' = . if provincestate != " National"
	replace DayDeaMeSmA01S00XNB`update' = . if provincestate != "New Brunswick"
	replace DayDeaMeSmA01S00XNL`update' = . if provincestate != "Newfoundland & Labrador"
	replace DayDeaMeSmA01S00XNS`update' = . if provincestate != "Nova Scotia"
	replace DayDeaMeSmA01S00XON`update' = . if provincestate != "Ontario"
	replace DayDeaMeSmA01S00XQC`update' = . if provincestate != "Quebec"
	replace DayDeaMeSmA01S00XSK`update' = . if provincestate != "Saskatchewan"
