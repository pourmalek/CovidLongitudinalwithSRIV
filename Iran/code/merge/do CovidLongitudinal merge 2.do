...
log using "log CovidLongitudinal merge 2.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal merge 2.do"
...
(line DayDeaMeSmA01`update' date, sort lcolor(red) lwidth(medthick)) /// 2 "DELP all"
(line DayDeaFOREA01`update' date, sort lcolor(red) lpattern(tight_dot) lwidth(vthick)) /// 3 "DELP forecast"
(line DayDeaMeSmA02`update' date, sort lcolor(black) lwidth(medthick)) /// 4 "IHME all"
...
ytitle(Daily deaths) title("C19 daily deaths, $country, all models, update `update'", size(medium) color(black)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "DELP" 4 "IHME" 6 "IMPE" 8 "LANL" 10 "SRIV") size(small) row(1)) ///
...
view "log CovidLongitudinal merge 2.smcl"
