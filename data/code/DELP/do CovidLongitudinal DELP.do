...
save "DELP `update'.dta", replace

shell mv -f "Global_`update'.csv" 
...
shell mv -f "Global_V2_`update'.csv" 
...
shell mv -f "Global_V2_since100_`update'.csv" 
...
shell mv -f "Global_V4_since100_`update'.csv" 
