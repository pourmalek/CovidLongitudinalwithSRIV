...
log using "log CovidLongitudinal Belize 6 SRIV.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Belize 6 SRIV.do"
...
* input data files: "SRIV Belize.dta"
* output data files: "SRIV Belize error.dta" (with error measures saved)

* output data dictionary files: "SRIV Belize error data dictionary.csv"
...
** graphs:
* "graph 03 Belize SRIV C19 daily deaths error.pdf"
* "graph 04 Belize SRIV C19 daily deaths absolute error.pdf"
* "graph 05 Belize SRIV C19 daily deaths percent error.pdf"
* "graph 06 Belize SRIV C19 daily deaths absolute percent error.pdf"

* "graph 07 Belize SRIV C19 daily deaths average median error.pdf"
* "graph 08 Belize SRIV C19 daily deaths average median absolute error.pdf"
* "graph 09 Belize SRIV C19 daily deaths average median percent error.pdf"
* "graph 10 Belize SRIV C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Belize SRIV C19 daily deaths Average MAPE over updates and calendar months
...
qui replace DDErrorSRIV`update' = . if date < td(20sep2020) // 20sep2020 is the earliest date of SRIV forecasts for Belize
                                                            // <<-- modify 3
...
qui replace DDAbsErrSRIV`update' = . if date < td(20sep2020) // 20sep2020 is the earliest date of SRIV forecasts for Belize
...
qui replace DDPerErrSRIV`update' = . if date < td(20sep2020) // 20sep2020 is the earliest date of SRIV forecasts for Belize
...
qui replace DDAbPeErSRIV`update' = . if date < td(20sep2020) // 20sep2020 is the earliest date of SRIV forecasts for Belize
...
qui replace DDErrorSRIV`update'_Med1 = . if date < td(20sep2020) // 20sep2020 is the earliest date of SRIV forecasts for Belize
...
qui replace DDAbsErrSRIV`update'_Med1 = . if date < td(20sep2020) // 20sep2020 is the earliest date of SRIV forecasts for Belize
...
qui replace DDPerErrSRIV`update'_Med1 = . if date < td(20sep2020) // 20sep2020 is the earliest date of SRIV forecasts for Belize
...
qui replace DDAbPeErSRIV`update'_Med1 = . if date < td(20sep2020) // 20sep2020 is the earliest date of SRIV forecasts for Belize
...
egen DDErrorSRIV_Mean1 = rowmean(DDErrorSRIV20221231_Med1-DDErrorSRIV20200920_Med1) // <<-- modify 5
...
qui replace DDErrorSRIV_Mean1 = . if date < td(20sep2020) // 20sep2020 is the earliest date of SRIV forecasts for Belize
...
egen DDAbsErrSRIV_Mean1 = rowmean(DDAbsErrSRIV20221231_Med1-DDAbsErrSRIV20200920_Med1) // <<-- modify 7
...
qui replace DDAbsErrSRIV_Mean1 = . if date < td(20sep2020) // 20sep2020 is the earliest date of SRIV forecasts for Belize
...
egen DDPerErrSRIV_Mean1 = rowmean(DDPerErrSRIV20221231_Med1-DDPerErrSRIV20200920_Med1) // <<-- modify 9
...
qui replace DDPerErrSRIV_Mean1 = . if date < td(20sep2020) // 20sep2020 is the earliest date of SRIV forecasts for Belize
...
egen DDAbPeErSRIV_Mean1 = rowmean(DDAbPeErSRIV20221231_Med1-DDAbPeErSRIV20200920_Med1) // <<-- modify 11
...
qui replace DDAbPeErSRIV_Mean1 = . if date < td(20sep2020) // 20sep2020 is the earliest date of SRIV forecasts for Belize
...
subtitle("Belize, SRIV, all updates, forecast only", size(small)) 

qui graph export "graph 03 Belize SRIV C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Belize SRIV C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Belize SRIV C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Belize SRIV C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Belize, SRIV, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Belize SRIV C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Belize SRIV C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Belize SRIV C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Belize SRIV C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Belize, SRIV, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Belize SRIV C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "SRIV Belize error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "SRIV Belize error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Belize 6 SRIV.smcl"
