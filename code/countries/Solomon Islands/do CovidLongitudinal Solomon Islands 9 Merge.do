...
log using "log CovidLongitudinal Solomon Islands 9 Merge.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Solomon Islands 9 Merge.do"
...
** input data files: "`model' Solomon Islands error.dta"

** output data files: "ALL MODELS Solomon Islands error.dta" with all date
*                     "ALL MODELS Solomon Islands error - only models across error measures.dta", replace
*                     "ALL MODELS Solomon Islands error - only error measures across models.dta", replace

* output data dictionary files: "ALL MODELS Solomon Islands error data dictionary.csv"
*                               "ALL MODELS Solomon Islands error - only models across error measures data dictionary.csv"
*                               "ALL MODELS Solomon Islands error - only error measures across models data dictionary.csv"


** Graphs:
* "graph 03 Solomon Islands ALL MODELS C19 daily deaths error.pdf"
* "graph 04 Solomon Islands ALL MODELS C19 daily deaths absolute error.pdf"
* "graph 05 Solomon Islands ALL MODELS C19 daily deaths percent error.pdf"
* "graph 06 Solomon Islands ALL MODELS C19 daily deaths absolute percent error.pdf"

* "graph 07a1 Solomon Islands ALL MODELS C19 daily deaths average median error.pdf"
* "graph 07a2 Solomon Islands ALL MODELS C19 daily deaths average median error smoothed.pdf"
* "graph 08a1 Solomon Islands ALL MODELS C19 daily deaths average median absolute error.pdf"
* "graph 08a2 Solomon Islands ALL MODELS C19 daily deaths average median absolute error smoothed.pdf"
* "graph 09a1 Solomon Islands ALL MODELS C19 daily deaths average median percent error.pdf"
* "graph 09a2 Solomon Islands ALL MODELS C19 daily deaths average median percent error smoothed.pdf"
* "graph 10a1 Solomon Islands ALL MODELS C19 daily deaths average median absolute percent error.pdf"
* "graph 10a2 Solomon Islands ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf"

****** graph each same error measure across models:
* "graph 12a Solomon Islands ALL MODELS C19 daily deaths Average Mean Error.pdf"
* "graph 12b Solomon Islands ALL MODELS C19 daily deaths Average Absolute Error.pdf"
* "graph 12c Solomon Islands ALL MODELS C19 daily deaths Average Percent Error.pdf"
* "graph 12d Solomon Islands ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf"

****** graph all models across error measures:
* "graph 13a Solomon Islands ALL MODELS C19 daily deaths, models across error measures.pdf"

****** graph all error measures across models:
* "graph 13b Solomon Islands ALL MODELS C19 daily deaths, error measures across models.pdf"
...
use "IMPE Solomon Islands error.dta", clear 
...
subtitle("Solomon Islands, all Models, all updates, forecast only", size(small)) ///
legend(position(6) order(1 "IMPE") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 03 Solomon Islands ALL MODELS C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Solomon Islands ALL MODELS C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Solomon Islands ALL MODELS C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Solomon Islands ALL MODELS C19 daily deaths absolute percent error.pdf", replace
...
save "ALL MODELS Solomon Islands error.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Solomon Islands error data dictionary.csv", replace 
...
use "ALL MODELS Solomon Islands error.dta", clear

save "ALL MODELS Solomon Islands error - only models across error measures.dta", replace
...
save "CovidLongitudinal Solomon Islands merge temp.dta", replace 
...
qui graph export "graph 13a Solomon Islands ALL MODELS C19 daily deaths, models across error measures.pdf", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Solomon Islands error - only models across error measures data dictionary.csv", replace 
...
use "CovidLongitudinal Solomon Islands merge temp.dta", clear 
...
save "ALL MODELS Solomon Islands error - only error measures across models.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Solomon Islands error - only error measures across models data dictionary.csv", replace 
...
view "log CovidLongitudinal Solomon Islands 9 Merge.smcl"
