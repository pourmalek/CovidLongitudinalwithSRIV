...
log using "log CovidLongitudinal Saint Kitts and Nevis 9 Merge.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Saint Kitts and Nevis 9 Merge.do"
...
** input data files: "`model' Saint Kitts and Nevis error.dta"

** output data files: "ALL MODELS Saint Kitts and Nevis error.dta" with all date
*                     "ALL MODELS Saint Kitts and Nevis error - only models across error measures.dta", replace
*                     "ALL MODELS Saint Kitts and Nevis error - only error measures across models.dta", replace

* output data dictionary files: "ALL MODELS Saint Kitts and Nevis error data dictionary.csv"
*                               "ALL MODELS Saint Kitts and Nevis error - only models across error measures data dictionary.csv"
*                               "ALL MODELS Saint Kitts and Nevis error - only error measures across models data dictionary.csv"


** Graphs:
* "graph 03 Saint Kitts and Nevis ALL MODELS C19 daily deaths error.pdf"
* "graph 04 Saint Kitts and Nevis ALL MODELS C19 daily deaths absolute error.pdf"
* "graph 05 Saint Kitts and Nevis ALL MODELS C19 daily deaths percent error.pdf"
* "graph 06 Saint Kitts and Nevis ALL MODELS C19 daily deaths absolute percent error.pdf"

* "graph 07a1 Saint Kitts and Nevis ALL MODELS C19 daily deaths average median error.pdf"
* "graph 07a2 Saint Kitts and Nevis ALL MODELS C19 daily deaths average median error smoothed.pdf"
* "graph 08a1 Saint Kitts and Nevis ALL MODELS C19 daily deaths average median absolute error.pdf"
* "graph 08a2 Saint Kitts and Nevis ALL MODELS C19 daily deaths average median absolute error smoothed.pdf"
* "graph 09a1 Saint Kitts and Nevis ALL MODELS C19 daily deaths average median percent error.pdf"
* "graph 09a2 Saint Kitts and Nevis ALL MODELS C19 daily deaths average median percent error smoothed.pdf"
* "graph 10a1 Saint Kitts and Nevis ALL MODELS C19 daily deaths average median absolute percent error.pdf"
* "graph 10a2 Saint Kitts and Nevis ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf"

****** graph each same error measure across models:
* "graph 12a Saint Kitts and Nevis ALL MODELS C19 daily deaths Average Mean Error.pdf"
* "graph 12b Saint Kitts and Nevis ALL MODELS C19 daily deaths Average Absolute Error.pdf"
* "graph 12c Saint Kitts and Nevis ALL MODELS C19 daily deaths Average Percent Error.pdf"
* "graph 12d Saint Kitts and Nevis ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf"

****** graph all models across error measures:
* "graph 13a Saint Kitts and Nevis ALL MODELS C19 daily deaths, models across error measures.pdf"

****** graph all error measures across models:
* "graph 13b Saint Kitts and Nevis ALL MODELS C19 daily deaths, error measures across models.pdf"
...
use "SRIV Saint Kitts and Nevis error.dta", clear 
	
	merge m:m date using "SRIV Saint Kitts and Nevis error.dta"	
...
subtitle("Saint Kitts and Nevis, all Models, all updates, forecast only", size(small)) ///
legend(position(6) order(1 "SRIV") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 03 Saint Kitts and Nevis ALL MODELS C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Saint Kitts and Nevis ALL MODELS C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Saint Kitts and Nevis ALL MODELS C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Saint Kitts and Nevis ALL MODELS C19 daily deaths absolute percent error.pdf", replace
...
save "ALL MODELS Saint Kitts and Nevis error.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Saint Kitts and Nevis error data dictionary.csv", replace 
...
use "ALL MODELS Saint Kitts and Nevis error.dta", clear

save "ALL MODELS Saint Kitts and Nevis error - only models across error measures.dta", replace
...
save "CovidLongitudinal Saint Kitts and Nevis merge temp.dta", replace 
...
qui graph export "graph 13a Saint Kitts and Nevis ALL MODELS C19 daily deaths, models across error measures.pdf", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Saint Kitts and Nevis error - only models across error measures data dictionary.csv", replace 
...
use "CovidLongitudinal Saint Kitts and Nevis merge temp.dta", clear 
...
gen country = "Saint Kitts and Nevis"
...
save "ALL MODELS Saint Kitts and Nevis error - only error measures across models.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Saint Kitts and Nevis error - only error measures across models data dictionary.csv", replace 
...
view "log CovidLongitudinal Saint Kitts and Nevis 9 Merge.smcl"
