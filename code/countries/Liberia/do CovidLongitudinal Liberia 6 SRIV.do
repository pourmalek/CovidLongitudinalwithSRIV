...
log using "log CovidLongitudinal Liberia 6 SRIV.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Liberia 6 SRIV.do"
...
* input data files: "SRIV Liberia.dta"
* output data files: "SRIV Liberia error.dta" (with error measures saved)

* output data dictionary files: "SRIV Liberia error data dictionary.csv"
...
** graphs:
* "graph 03 Liberia SRIV C19 daily deaths error.pdf"
* "graph 04 Liberia SRIV C19 daily deaths absolute error.pdf"
* "graph 05 Liberia SRIV C19 daily deaths percent error.pdf"
* "graph 06 Liberia SRIV C19 daily deaths absolute percent error.pdf"

* "graph 07 Liberia SRIV C19 daily deaths average median error.pdf"
* "graph 08 Liberia SRIV C19 daily deaths average median absolute error.pdf"
* "graph 09 Liberia SRIV C19 daily deaths average median percent error.pdf"
* "graph 10 Liberia SRIV C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Liberia SRIV C19 daily deaths Average MAPE over updates and calendar months
...
qui replace DDErrorSRIV`update' = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Liberia
                                                            // <<-- modify 3
...
qui replace DDAbsErrSRIV`update' = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Liberia
...
qui replace DDPerErrSRIV`update' = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Liberia
...
qui replace DDAbPeErSRIV`update' = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Liberia
...
qui replace DDErrorSRIV`update'_Med1 = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Liberia
...
qui replace DDAbsErrSRIV`update'_Med1 = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Liberia
...
qui replace DDPerErrSRIV`update'_Med1 = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Liberia
...
qui replace DDAbPeErSRIV`update'_Med1 = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Liberia
...
qui replace DDErrorSRIV_Mean1 = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Liberia
...
qui replace DDAbsErrSRIV_Mean1 = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Liberia
...
qui replace DDPerErrSRIV_Mean1 = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Liberia
...
qui replace DDAbPeErSRIV_Mean1 = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Liberia
...
subtitle("Liberia, SRIV, all updates, forecast only", size(small)) 

qui graph export "graph 03 Liberia SRIV C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Liberia SRIV C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Liberia SRIV C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Liberia SRIV C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Liberia, SRIV, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Liberia SRIV C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Liberia SRIV C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Liberia SRIV C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Liberia SRIV C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Liberia, SRIV, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Liberia SRIV C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "SRIV Liberia error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "SRIV Liberia error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Liberia 6 SRIV.smcl"
