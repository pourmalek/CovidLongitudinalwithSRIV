...
log using "log CovidLongitudinal Korea North 9 Merge.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Korea North 9 Merge.do"
...
** input data files: "`model' Korea North error.dta"

** output data files: "ALL MODELS Korea North error.dta" with all date
*                     "ALL MODELS Korea North error - only models across error measures.dta", replace
*                     "ALL MODELS Korea North error - only error measures across models.dta", replace

* output data dictionary files: "ALL MODELS Korea North error data dictionary.csv"
*                               "ALL MODELS Korea North error - only models across error measures data dictionary.csv"
*                               "ALL MODELS Korea North error - only error measures across models data dictionary.csv"


** Graphs:
* "graph 03 Korea North ALL MODELS C19 daily deaths error.pdf"
* "graph 04 Korea North ALL MODELS C19 daily deaths absolute error.pdf"
* "graph 05 Korea North ALL MODELS C19 daily deaths percent error.pdf"
* "graph 06 Korea North ALL MODELS C19 daily deaths absolute percent error.pdf"

* "graph 07a1 Korea North ALL MODELS C19 daily deaths average median error.pdf"
* "graph 07a2 Korea North ALL MODELS C19 daily deaths average median error smoothed.pdf"
* "graph 08a1 Korea North ALL MODELS C19 daily deaths average median absolute error.pdf"
* "graph 08a2 Korea North ALL MODELS C19 daily deaths average median absolute error smoothed.pdf"
* "graph 09a1 Korea North ALL MODELS C19 daily deaths average median percent error.pdf"
* "graph 09a2 Korea North ALL MODELS C19 daily deaths average median percent error smoothed.pdf"
* "graph 10a1 Korea North ALL MODELS C19 daily deaths average median absolute percent error.pdf"
* "graph 10a2 Korea North ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf"

****** graph each same error measure across models:
* "graph 12a Korea North ALL MODELS C19 daily deaths Average Mean Error.pdf"
* "graph 12b Korea North ALL MODELS C19 daily deaths Average Absolute Error.pdf"
* "graph 12c Korea North ALL MODELS C19 daily deaths Average Percent Error.pdf"
* "graph 12d Korea North ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf"

****** graph all models across error measures:
* "graph 13a Korea North ALL MODELS C19 daily deaths, models across error measures.pdf"

****** graph all error measures across models:
* "graph 13b Korea North ALL MODELS C19 daily deaths, error measures across models.pdf"
...
use "IMPE Korea North error.dta", clear 
...
subtitle("Korea North, all Models, all updates, forecast only", size(small)) ///
legend(position(6) order(1 "IMPE") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 03 Korea North ALL MODELS C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Korea North ALL MODELS C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Korea North ALL MODELS C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Korea North ALL MODELS C19 daily deaths absolute percent error.pdf", replace
...
save "ALL MODELS Korea North error.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Korea North error data dictionary.csv", replace 
...
use "ALL MODELS Korea North error.dta", clear

save "ALL MODELS Korea North error - only models across error measures.dta", replace
...
save "CovidLongitudinal Korea North merge temp.dta", replace 
...
qui graph export "graph 13a Korea North ALL MODELS C19 daily deaths, models across error measures.pdf", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Korea North error - only models across error measures data dictionary.csv", replace 
...
use "CovidLongitudinal Korea North merge temp.dta", clear 
...
save "ALL MODELS Korea North error - only error measures across models.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Korea North error - only error measures across models data dictionary.csv", replace 
...
view "log CovidLongitudinal Korea North 9 Merge.smcl"
