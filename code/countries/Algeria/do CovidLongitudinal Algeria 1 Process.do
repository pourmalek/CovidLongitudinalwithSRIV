...
** graphs:
** "graph 2 Algeria `model' C19 daily deaths all updates.pdf"
** "graph 2 Algeria ALL MODELS C19 daily deaths all updates.pdf"
...
qui graph export "graph 2 Algeria JOHN C19 daily deaths reported.pdf", replace
...
qui graph export "graph 2 Algeria DELP C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	*/
	...
	// qui graph export "graph Algeria 0 IHME daily deaths epoch `update'.pdf", replace
...
qui graph export "graph 2 Algeria IHME C19 daily deaths all updates.pdf", replace
...
qui graph export "graph 2 Algeria IMPE C19 daily deaths all updates.pdf", replace
...
qui graph export "graph 2 Algeria LANL C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "SRIV `update' Algeria.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "SRIV `update' Algeria.dta"
...
preserve
    ...
    export delimited name varlab using "SRIV Algeria data dictionary.csv", replace 
...
* graph Algeria SRIV daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small)) ylabel(, labsize(small) angle(forty_five)) ///
ytitle(Daily deaths) title("C19 daily deaths, Algeria, SRIV, all updates", size(medium) color(black)) ///
legend(order(1 "JOHN" 2 "SRIV Forecast") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 2 Algeria SRIV C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only  
	...
	save "UCLA `update' Algeria.dta", replace 
	
	/* line DayDeaMeRaUCLA`update' DayDeaMeSmUCLA`update' DayDeaMeFoUCLA`update' date

	qui graph export "UCLA `update' Algeria.pdf", replace */
...
foreach update of local list {
	...
	merge m:m date using "UCLA `update' Algeria.dta"
...
preserve
    ...
    export delimited name varlab using "UCLA Algeria data dictionary.csv", replace 
...
* graph Algeria UCLA daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small)) ylabel(, labsize(small) angle(forty_five)) ///
ytitle(Daily deaths) title("C19 daily deaths, Algeria, UCLA, all updates", size(medium) color(black)) ///
legend(order(1 "JOHN" 2 "UCLA Forecast") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 2 Algeria UCLA C19 daily deaths all updates.pdf", replace
...
qui graph export "graph 2 Algeria YYGU C19 daily deaths all updates.pdf", replace
...
local list IHME IMPE LANL SRIV YYGU
...
legend(order(1625 "JOHN" 1 "DELP" 169 "IHME" 4 "IMPE" 3 "LANL" 12 "SRIV" 34 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 2 Algeria ALL MODELS C19 daily deaths all updates.pdf", replace
