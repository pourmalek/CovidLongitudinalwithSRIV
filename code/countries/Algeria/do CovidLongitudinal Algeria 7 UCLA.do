...
log using "log CovidLongitudinal Algeria 7 UCLA.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Algeria 7 UCLA.do"
...
* input data files: "UCLA Algeria.dta"
* output data files: "UCLA Algeria error.dta" (with error measures saved)

* output data dictionary files: "UCLA Algeria error data dictionary.csv"
...
** graphs:
* "graph 3 Algeria UCLA C19 daily deaths error.pdf"
* "graph 4 Algeria UCLA C19 daily deaths absolute error.pdf"
* "graph 5 Algeria UCLA C19 daily deaths percent error.pdf"
* "graph 6 Algeria UCLA C19 daily deaths absolute percent error.pdf"
* "graph 7 a Algeria UCLA C19 daily deaths average median error.pdf"
* "graph 7 b Algeria UCLA C19 daily deaths average median error smoothed.pdf"
* "graph 8 a Algeria UCLA C19 daily deaths average median absolute error.pdf"
* "graph 8 b Algeria UCLA C19 daily deaths average median absolute error smoothed.pdf"
* "graph 9 a Algeria UCLA C19 daily deaths average median percent error.pdf"
* "graph 9 b Algeria UCLA C19 daily deaths average median percent error smoothed.pdf"
* "graph 10 a Algeria UCLA C19 daily deaths average median absolute percent error.pdf"
* "graph 10 b Algeria UCLA C19 daily deaths average median absolute percent error smoothed.pdf"
* "graph 11 Algeria UCLA C19 daily deaths average Median Absolute Percent Error.pdf"
...
qui replace DDErrorUCLA`update' = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Algeria
                                                            // <<-- modify 3
...
qui replace DDAbsErrUCLA`update' = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Algeria
...
qui replace DDPerErrUCLA`update' = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Algeria
...
qui replace DDAbPeErUCLA`update' = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Algeria
...
qui replace DDErrorUCLA`update'_Med1 = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Algeria
...
qui replace DDAbsErrUCLA`update'_Med1 = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Algeria
...
qui replace DDPerErrUCLA`update'_Med1 = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Algeria
...
qui replace DDAbPeErUCLA`update'_Med1 = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Algeria
...
qui replace DDErrorUCLA_Mean1 = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Algeria
...
qui replace DDAbsErrUCLA_Mean1 = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Algeria
...
qui replace DDPerErrUCLA_Mean1 = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Algeria
...
qui replace DDAbPeErUCLA_Mean1 = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Algeria
...
subtitle("Algeria, UCLA, all updates, Forecast only", size(small)) 

qui graph export "graph 3 Algeria UCLA C19 daily deaths error.pdf", replace
...
qui graph export "graph 4 Algeria UCLA C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 5 Algeria UCLA C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 6 Algeria UCLA C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Algeria, UCLA, Forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 7 a Algeria UCLA C19 daily deaths average median error.pdf", replace
...
xlabel(, angle(forty_five)) ylabel(, format(%15.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths error measure) title("C19 daily deaths, average median error", size(medium) color(black)) /// 
subtitle("Algeria, UCLA, Forecast only; smoothed for better viewing", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 7 b Algeria UCLA C19 daily deaths average median error smoothed.pdf", replace
...
qui graph export "graph 8 a Algeria UCLA C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 8 b Algeria UCLA C19 daily deaths average median absolute error smoothed.pdf", replace
...
qui graph export "graph 9 a Algeria UCLA C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 9 b Algeria UCLA C19 daily deaths average median percent error smoothed.pdf", replace
...
qui graph export "graph 10 a Algeria UCLA C19 daily deaths average median absolute percent error.pdf", replace
...
qui graph export "graph 10 b Algeria UCLA C19 daily deaths average median absolute percent error smoothed.pdf", replace
...
subtitle("Algeria, UCLA, Forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) 

qui graph export "graph 11 Algeria UCLA C19 daily deaths average Median Absolute Percent Error.pdf", replace
...
save "UCLA Algeria error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "UCLA Algeria error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Algeria 7 UCLA.smcl"
