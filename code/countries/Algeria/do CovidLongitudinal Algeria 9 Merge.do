...
** Graphs:
* "graph 3 Algeria ALL MODELS C19 daily deaths error.pdf"
* "graph 4 Algeria ALL MODELS C19 daily deaths absolute error.pdf"
* "graph 5 Algeria ALL MODELS C19 daily deaths percent error.pdf"
* "graph 6 Algeria ALL MODELS C19 daily deaths absolute percent error.pdf"
* "graph 7 a Algeria ALL MODELS C19 daily deaths average median error.pdf"
* "graph 7 b Algeria ALL MODELS C19 daily deaths average median error smoothed.pdf"
* "graph 8 a Algeria ALL MODELS C19 daily deaths average median absolute error.pdf"
* "graph 8 b Algeria ALL MODELS C19 daily deaths average median absolute error smoothed.pdf"
* "graph 9 a Algeria ALL MODELS C19 daily deaths average median percent error.pdf"
* "graph 9 b Algeria ALL MODELS C19 daily deaths average median percent error smoothed.pdf"
* "graph 10 a Algeria ALL MODELS C19 daily deaths average median absolute percent error.pdf"
* "graph 10 b Algeria ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf"
****** graph each same error measure across models:
* "graph 11 a Algeria ALL MODELS C19 daily deaths Average Mean Error.pdf"
* "graph 11 b Algeria ALL MODELS C19 daily deaths Average Absolute Error.pdf"
* "graph 11 c Algeria ALL MODELS C19 daily deaths Average Percent Error.pdf"
* "graph 11 d Algeria ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf"
****** graph all models across error measures:
* "graph 12 a Algeria ALL MODELS C19 daily deaths, models across error measures.pdf"
****** graph all error measures across models:
* "graph 12 b Algeria ALL MODELS C19 daily deaths, error measures across models.pdf"
...
use "DELP Algeria error.dta", clear 
	...
	merge m:m date using "SRIV Algeria error.dta"	

	drop _merge
	
	/* Algeria not included in UCLA 
	
	merge m:m date using "UCLA Algeria error.dta", force
...
legend(order(1 "DELP" 183 "IHME" 4 "IMPE" 3 "LANL" 11 "SRIV" 35 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 3 Algeria ALL MODELS C19 daily deaths error.pdf", replace
...
qui graph export "graph 4 Algeria ALL MODELS C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 5 Algeria ALL MODELS C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 6 Algeria ALL MODELS C19 daily deaths absolute percent error.pdf", replace
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
legend(order(1 "DELP" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "SRIV" 6 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 7 a Algeria ALL MODELS C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 7 b Algeria ALL MODELS C19 daily deaths average median error smoothed.pdf", replace
...
qui graph export "graph 8 a Algeria ALL MODELS C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 8 b Algeria ALL MODELS C19 daily deaths average median absolute error smoothed.pdf", replace
...
qui graph export "graph 9 a Algeria ALL MODELS C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 9 b Algeria ALL MODELS C19 daily deaths average median percent error smoothed.pdf", replace
...
qui graph export "graph 10 a Algeria ALL MODELS C19 daily deaths average median absolute percent error.pdf", replace
...
qui graph export "graph 10 b Algeria ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf", replace
...
legend(order(1 "DELP" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "SRIV" 6 "YYGU") size(small) row(2)) 

qui graph export "graph 11 a Algeria ALL MODELS C19 daily deaths Average Mean Error.pdf", replace
...
bar(5, fcolor(green) lcolor(green)) ///
bar(6, fcolor(gold) lcolor(gold)) ///
blabel(bar, size(vsmall) orientation(horizontal) format(%10.0fc)) ylabel(, labsize(small) format(%10.0fc)) ///
ytitle("Average Absolute Error") yscale(titlegap(2)) ///
title("C19 daily deaths average of Absolute Error", size(medium) color(black)) ///
subtitle("Over updates and calendar months; Forecast only; Algeria", size(small)) /// 
legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "DELP" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "SRIV" 6 "YYGU") size(small) row(2)) 

qui graph export "graph 11 b Algeria ALL MODELS C19 daily deaths Average Absolute Error.pdf", replace
...
bar(6, fcolor(gold) lcolor(gold)) ///
blabel(bar, size(vsmall) orientation(horizontal) format(%10.0fc)) ylabel(, labsize(small) format(%10.0fc)) ///
ytitle("Average Percent Error") yscale(titlegap(2)) ///
title("C19 daily deaths average of Percent Error", size(medium) color(black)) ///
subtitle("Over updates and calendar months; Forecast only; Algeria", size(small)) /// 
legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "DELP" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "SRIV" 6 "YYGU") size(small) row(2)) 

qui graph export "graph 11 c Algeria ALL MODELS C19 daily deaths Average Percent Error.pdf", replace
...
bar(6, fcolor(gold) lcolor(gold)) ///
blabel(bar, size(vsmall) orientation(horizontal) format(%10.0fc)) ylabel(, labsize(small) format(%10.0fc)) ///
ytitle("Average Absolute Percent Error") yscale(titlegap(2)) ///
title("C19 daily deaths average of Absolute Percent Error", size(medium) color(black)) ///
subtitle("Over updates and calendar months; Forecast only; Algeria", size(small)) /// 
legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "DELP" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "SRIV" 6 "YYGU") size(small) row(2)) 

qui graph export "graph 11 d Algeria ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf", replace
...
rename ///
(DDErrorDELP_Mean2str DDErrorIHME_Mean2str DDErrorIMPE_Mean2str DDErrorLANL_Mean2str DDErrorSRIV_Mean2str DDErrorYYGU_Mean2str) ///
(DDErrorrDELP_Mean2str DDErrorrIHME_Mean2str DDErrorrIMPE_Mean2str DDErrorrLANL_Mean2str DDErrorrSRIV_Mean2str DDErrorrYYGU_Mean2str) 
...
blabel(bar, size(vsmall) orientation(horizontal) format(%10.0fc)) ylabel(, labsize(small) format(%10.0fc)) ///
ytitle("Average error measures") yscale(titlegap(2)) ///
...
qui graph export "graph 12 a Algeria ALL MODELS C19 daily deaths, models across error measures.pdf", replace
...
rename (DDErrorrDELP DDErrorrIHME DDErrorrIMPE DDErrorrLANL DDErrorrSRIV DDErrorrYYGU) ///
...
rename (DDAbsErrDELP DDAbsErrIHME DDAbsErrIMPE DDAbsErrLANL DDAbsErrSRIV DDAbsErrYYGU) ///
...
rename (DDPerErrDELP DDPerErrIHME DDPerErrIMPE DDPerErrLANL DDPerErrSRIV DDPerErrYYGU) ///
...
rename (DDAbPeErDELP DDAbPeErIHME DDAbPeErIMPE DDAbPeErLANL DDAbPeErSRIV DDAbPeErYYGU) ///
...
qui graph export "graph 12 b Algeria ALL MODELS C19 daily deaths, error measures across models.pdf", replace
...
rename (DDA1E1 DDA2E1 DDA3E1 DDA4E1 DDA5E1 DDA6E1) (DD_DELP_Errorr DD_IHME_Errorr DD_IMPE_Errorr DD_LANL_Errorr DD_SRIV_Errorr DD_YYGU_Errorr)
...
rename (DDA1E2 DDA2E2 DDA3E2 DDA4E2 DDA5E2 DDA6E2) (DD_DELP_AbsErr DD_IHME_AbsErr DD_IMPE_AbsErr DD_LANL_AbsErr DD_SRIV_AbsErr DD_YYGU_AbsErr)
...
rename (DDA1E3 DDA2E3 DDA3E3 DDA4E3 DDA5E3 DDA6E3) (DD_DELP_PerErr DD_IHME_PerErr DD_IMPE_PerErr DD_LANL_PerErr DD_SRIV_PerErr DD_YYGU_PerErr)
...
rename (DDA1E4 DDA2E4 DDA3E4 DDA4E4 DDA5E4 DDA6E4) (DD_DELP_AbPeEr DD_IHME_AbPeEr DD_IMPE_AbPeEr DD_LANL_AbPeEr DD_SRIV_AbPeEr DD_YYGU_AbPeEr)
...
order DD_UCLA_Errorr DD_UCLA_AbsErr DD_UCLA_PerErr DD_UCLA_AbPeEr, after(DD_SRIV_PerErr)
