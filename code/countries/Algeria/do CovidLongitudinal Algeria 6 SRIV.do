...
** graphs:
* "graph 03 Algeria SRIV C19 daily deaths error.pdf"
* "graph 04 Algeria SRIV C19 daily deaths absolute error.pdf"
* "graph 05 Algeria SRIV C19 daily deaths percent error.pdf"
* "graph 06 Algeria SRIV C19 daily deaths absolute percent error.pdf"

* "graph 07 Algeria SRIV C19 daily deaths average median error.pdf"
* "graph 08 Algeria SRIV C19 daily deaths average median absolute error.pdf"
* "graph 09 Algeria SRIV C19 daily deaths average median percent error.pdf"
* "graph 10 Algeria SRIV C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Algeria SRIV C19 daily deaths Average MAPE over updates and calendar months
...
qui graph export "graph 03 Algeria SRIV C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Algeria SRIV C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Algeria SRIV C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Algeria SRIV C19 daily deaths absolute percent error.pdf", replace
...
qui graph export "graph 07 Algeria SRIV C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Algeria SRIV C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Algeria SRIV C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Algeria SRIV C19 daily deaths average median absolute percent error.pdf", replace
...
qui graph export "graph 11 Algeria SRIV C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
