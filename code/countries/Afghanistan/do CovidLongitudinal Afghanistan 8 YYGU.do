...
log using "log CovidLongitudinal Afghanistan 8 YYGU.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Afghanistan 8 YYGU.do"
...
* input data files: "YYGU Afghanistan.dta"
* output data files: "YYGU Afghanistan error.dta" (with error measures saved)

* output data dictionary files: "YYGU Afghanistan error data dictionary.csv"
...
** graphs:
* "graph 3 Afghanistan YYGU C19 daily deaths error.pdf"
* "graph 4 Afghanistan YYGU C19 daily deaths absolute error.pdf"
* "graph 5 Afghanistan YYGU C19 daily deaths percent error.pdf"
* "graph 6 Afghanistan YYGU C19 daily deaths absolute percent error.pdf"
* "graph 7 a Afghanistan YYGU C19 daily deaths average median error.pdf"
* "graph 7 b Afghanistan YYGU C19 daily deaths average median error smoothed.pdf"
* "graph 8 a Afghanistan YYGU C19 daily deaths average median absolute error.pdf"
* "graph 8 b Afghanistan YYGU C19 daily deaths average median absolute error smoothed.pdf"
* "graph 9 a Afghanistan YYGU C19 daily deaths average median percent error.pdf"
* "graph 9 b Afghanistan YYGU C19 daily deaths average median percent error smoothed.pdf"
* "graph 10 a Afghanistan YYGU C19 daily deaths average median absolute percent error.pdf"
* "graph 10 b Afghanistan YYGU C19 daily deaths average median absolute percent error smoothed.pdf"
* "graph 11 Afghanistan YYGU C19 daily deaths average Median Absolute Percent Error.pdf"
...
use "YYGU Afghanistan.dta", clear 
...
qui replace DDErrorYYGU`update' = . if date < td(18May2020) // 18May2020 is the earliest date of YYGU Forecasts for Afghanistan
                                                            // <<-- modify 3
...
qui replace DDAbsErrYYGU`update' = . if date < td(18May2020) // 18May2020 is the earliest date of YYGU Forecasts for Afghanistan
...
qui replace DDPerErrYYGU`update' = . if date < td(18May2020) // 18May2020 is the earliest date of YYGU Forecasts for Afghanistan
...
qui replace DDAbPeErYYGU`update' = . if date < td(18May2020) // 18May2020 is the earliest date of YYGU Forecasts for Afghanistan
...
qui replace DDErrorYYGU`update'_Med1 = . if date < td(18May2020) // 18May2020 is the earliest date of YYGU Forecasts for Afghanistan
...
qui replace DDAbsErrYYGU`update'_Med1 = . if date < td(18May2020) // 18May2020 is the earliest date of YYGU Forecasts for Afghanistan
...
qui replace DDPerErrYYGU`update'_Med1 = . if date < td(18May2020) // 18May2020 is the earliest date of YYGU Forecasts for Afghanistan
...
qui replace DDAbPeErYYGU`update'_Med1 = . if date < td(18May2020) // 18May2020 is the earliest date of YYGU Forecasts for Afghanistan
...
qui replace DDErrorYYGU_Mean1 = . if date < td(18May2020) // 18May2020 is the earliest date of YYGU Forecasts for Afghanistan
...
qui replace DDAbsErrYYGU_Mean1 = . if date < td(18May2020) // 18May2020 is the earliest date of YYGU Forecasts for Afghanistan
...
qui replace DDPerErrYYGU_Mean1 = . if date < td(18May2020) // 18May2020 is the earliest date of YYGU Forecasts for Afghanistan
...
qui replace DDAbPeErYYGU_Mean1 = . if date < td(18May2020) // 18May2020 is the earliest date of YYGU Forecasts for Afghanistan
...
subtitle("Afghanistan, YYGU, all updates, Forecast only", size(small)) 

qui graph export "graph 3 Afghanistan YYGU C19 daily deaths error.pdf", replace
...
qui graph export "graph 4 Afghanistan YYGU C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 5 Afghanistan YYGU C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 6 Afghanistan YYGU C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Afghanistan, YYGU, Forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 7 a Afghanistan YYGU C19 daily deaths average median error.pdf", replace
...
xlabel(, angle(forty_five)) ylabel(, format(%15.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths error measure) title("C19 daily deaths, average median error", size(medium) color(black)) /// 
subtitle("Afghanistan, YYGU, Forecast only; smoothed for better viewing", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 7 b Afghanistan YYGU C19 daily deaths average median error smoothed.pdf", replace
...
qui graph export "graph 8 a Afghanistan YYGU C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 8 b Afghanistan YYGU C19 daily deaths average median absolute error smoothed.pdf", replace
...
qui graph export "graph 9 a Afghanistan YYGU C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 9 b Afghanistan YYGU C19 daily deaths average median percent error smoothed.pdf", replace
...
qui graph export "graph 10 a Afghanistan YYGU C19 daily deaths average median absolute percent error.pdf", replace
...
qui graph export "graph 10 b Afghanistan YYGU C19 daily deaths average median absolute percent error smoothed.pdf", replace
...
subtitle("Afghanistan, YYGU, Forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) 

qui graph export "graph 11 Afghanistan YYGU C19 daily deaths average Median Absolute Percent Error.pdf", replace
...
save "YYGU Afghanistan error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "YYGU Afghanistan error data dictionary.csv", replace 
...
view "log CovidLongitudinal Afghanistan 8 YYGU.smcl"
