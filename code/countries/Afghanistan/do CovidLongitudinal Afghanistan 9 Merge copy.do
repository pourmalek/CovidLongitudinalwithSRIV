...
log using "log CovidLongitudinal Afghanistan 9.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Afghanistan 9.do"
...
** Graphs:
* "graph 3 Afghanistan ALL MODELS C19 daily deaths error.pdf"
* "graph 4 Afghanistan ALL MODELS C19 daily deaths absolute error.pdf"
* "graph 5 Afghanistan ALL MODELS C19 daily deaths percent error.pdf"
* "graph 6 Afghanistan ALL MODELS C19 daily deaths absolute percent error.pdf"
* "graph 7 a Afghanistan ALL MODELS C19 daily deaths average median error.pdf"
* "graph 7 b Afghanistan ALL MODELS C19 daily deaths average median error smoothed.pdf"
* "graph 8 a Afghanistan ALL MODELS C19 daily deaths average median absolute error.pdf"
* "graph 8 b Afghanistan ALL MODELS C19 daily deaths average median absolute error smoothed.pdf"
* "graph 9 a Afghanistan ALL MODELS C19 daily deaths average median percent error.pdf"
* "graph 9 b Afghanistan ALL MODELS C19 daily deaths average median percent error smoothed.pdf"
* "graph 10 a Afghanistan ALL MODELS C19 daily deaths average median absolute percent error.pdf"
* "graph 10 b Afghanistan ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf"
****** graph each same error measure across models:
* "graph 11 a Afghanistan ALL MODELS C19 daily deaths Average Mean Error.pdf"
* "graph 11 b Afghanistan ALL MODELS C19 daily deaths Average Absolute Error.pdf"
* "graph 11 c Afghanistan ALL MODELS C19 daily deaths Average Percent Error.pdf"
* "graph 11 d Afghanistan ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf"
...
use "DELP Afghanistan error.dta", clear 
	...
	merge m:m date using "SRIV Afghanistan error.dta"	

	drop _merge
	
	merge m:m date using "UCLA Afghanistan error.dta", force
	
	drop _merge
	
	merge m:m date using "YYGU Afghanistan error.dta", force	
...
legend(order(1 "DELP" 34 "IHME" 4 "IMPE" 3 "LANL" 11 "SRIV" 626 "UCLA" 37 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 3 Afghanistan ALL MODELS C19 daily deaths error.pdf", replace
...
qui graph export "graph 4 Afghanistan ALL MODELS C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 5 Afghanistan ALL MODELS C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 6 Afghanistan ALL MODELS C19 daily deaths absolute percent error.pdf", replace
...
qui graph export "graph 7 a Afghanistan ALL MODELS C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 7 b Afghanistan ALL MODELS C19 daily deaths average median error smoothed.pdf", replace
...
qui graph export "graph 8 a Afghanistan ALL MODELS C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 8 b Afghanistan ALL MODELS C19 daily deaths average median absolute error smoothed.pdf", replace
...
qui graph export "graph 9 a Afghanistan ALL MODELS C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 9 b Afghanistan ALL MODELS C19 daily deaths average median percent error smoothed.pdf", replace
...
qui graph export "graph 10 a Afghanistan ALL MODELS C19 daily deaths average median absolute percent error.pdf", replace
...
qui graph export "graph 10 b Afghanistan ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf", replace
...
qui graph export "graph 11 a Afghanistan ALL MODELS C19 daily deaths Average Mean Error.pdf", replace
...
qui graph export "graph 11 b Afghanistan ALL MODELS C19 daily deaths Average Absolute Error.pdf", replace
...
qui graph export "graph 11 c Afghanistan ALL MODELS C19 daily deaths Average Percent Error.pdf", replace
...
qui graph export "graph 11 d Afghanistan ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf", replace
...
blabel(bar, size(vsmall)) ytitle("Average error measures") yscale(titlegap(2)) ///
...
qui graph export "graph 12 a Afghanistan ALL MODELS C19 daily deaths, models across error measures.pdf", replace
...
view "log CovidLongitudinal Afghanistan 9.smcl"
