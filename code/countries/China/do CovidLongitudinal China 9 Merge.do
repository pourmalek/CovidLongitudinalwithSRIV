...
use "IHME China error.dta", clear 
	...
	merge m:m date using "SRIV China error.dta"	
...
legend(position(6) order(273 "IHME" 379 "IMPE" 1 "LANL" 3 "SRIV" 20 "YYGU") ///
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
legend(position(6) order(1 "IHME" 2 "IMPE" 3 "LANL" 4 "SRIV" 5 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand)
...
legend(position(6) order(1 "IHME" 2 "IMPE" 3 "LANL" 4 "SRIV" 5 "YYGU") size(small) row(2)) 
...
rename ///
(DDErrorIHME_Mean2 DDErrorIMPE_Mean2 DDErrorLANL_Mean2 DDErrorSRIV_Mean2 DDErrorYYGU_Mean2) ///
(DDErrorrIHME_Mean2 DDErrorrIMPE_Mean2 DDErrorrLANL_Mean2 DDErrorrSRIV_Mean2 DDErrorrYYGU_Mean2) 
...
rename (DDErrorrIHME DDErrorrIMPE DDErrorrLANL DDErrorrSRIV DDErrorrYYGU) ///
...
rename (DDAbsErrIHME DDAbsErrIMPE DDAbsErrLANL DDAbsErrSRIV DDAbsErrYYGU) ///
...
rename (DDPerErrIHME DDPerErrIMPE DDPerErrLANL DDPerErrSRIV DDPerErrYYGU) ///
...
rename (DDAbPeErIHME DDAbPeErIMPE DDAbPeErLANL DDAbPeErSRIV DDAbPeErYYGU) ///
...
rename (DDA1E1 DDA2E1 DDA3E1 DDA4E1 DDA5E1) ///
       (DD_IHME_Errorr DD_IMPE_Errorr DD_LANL_Errorr DD_SRIV_Errorr DD_YYGU_Errorr)
...
rename (DDA1E2 DDA2E2 DDA3E2 DDA4E2 DDA5E2) ///
       (DD_IHME_AbsErr DD_IMPE_AbsErr DD_LANL_AbsErr DD_SRIV_AbsErr DD_YYGU_AbsErr)
...
rename (DDA1E3 DDA2E3 DDA3E3 DDA4E3 DDA5E3) ///
       (DD_IHME_PerErr DD_IMPE_PerErr DD_LANL_PerErr DD_SRIV_PerErr DD_YYGU_PerErr)
...
(DD_IHME_AbPeEr DD_IMPE_AbPeEr DD_LANL_AbPeEr DD_SRIV_AbPeEr DD_YYGU_AbPeEr)
