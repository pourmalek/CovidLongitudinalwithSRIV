...
use "DELP Bhutan error.dta", clear 
	...
	merge m:m date using "SRIV Bhutan error.dta"	
...
legend(position(6) order(106 "DELP" 182 "IMPE" 1 "SRIV") ///
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
legend(position(6) order(1 "DELP" 2 "IMPE" 3 "SRIV") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand)
...
legend(position(6) order(1 "DELP" 2 "IMPE" 3 "SRIV") size(small) row(1)) 
...
rename ///
(DDErrorDELP_Mean2 DDErrorIMPE_Mean2 DDErrorSRIV_Mean2) ///
(DDErrorrDELP_Mean2 DDErrorrIMPE_Mean2 DDErrorrSRIV_Mean2) 
...
rename (DDErrorrDELP DDErrorrIMPE DDErrorrSRIV) ///
...
rename (DDAbsErrDELP DDAbsErrIMPE DDAbsErrSRIV) ///
...
rename (DDPerErrDELP DDPerErrIMPE DDPerErrSRIV) ///
...
rename (DDAbPeErDELP DDAbPeErIMPE DDAbPeErSRIV) ///
...
rename (DDA1E1 DDA2E1 DDA3E1) ///
       (DD_DELP_Errorr DD_IMPE_Errorr DD_SRIV_Errorr)
...
rename (DDA1E2 DDA2E2 DDA3E2) ///
       (DD_DELP_AbsErr DD_IMPE_AbsErr DD_SRIV_AbsErr)
...
rename (DDA1E3 DDA2E3 DDA3E3) ///
       (DD_DELP_PerErr DD_IMPE_PerErr DD_SRIV_PerErr)
...
(DD_DELP_AbPeEr DD_IMPE_AbPeEr DD_SRIV_AbPeEr)
