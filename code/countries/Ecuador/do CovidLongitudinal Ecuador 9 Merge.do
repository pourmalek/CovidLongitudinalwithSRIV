...
use "DELP Ecuador error.dta", clear 
	...
	merge m:m date using "SRIV Ecuador error.dta"	
...
legend(position(6) order(1 "DELP" 33 "IHME" 4 "IMPE" 2 "LANL" 10 "SRIV" 613 "UCLA" 36 "YYGU") ///
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
subtitle("Ecuador, all Models, all updates, forecast only", size(small)) ///
legend(position(6) order(1 "DELP" 34 "IHME" 4 "IMPE" 3 "LANL" 11 "SRIV" 614 "UCLA" 37 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand)
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
legend(position(6) order(1 "DELP" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "SRIV" 6 "UCLA" 7 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand)
...
legend(position(6) order(1 "DELP" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "SRIV" 6 "UCLA" 7 "YYGU") size(small) row(2)) 
...
rename ///
(DDErrorDELP_Mean2 DDErrorIHME_Mean2 DDErrorIMPE_Mean2 DDErrorLANL_Mean2 DDErrorSRIV_Mean2 DDErrorUCLA_Mean2 DDErrorYYGU_Mean2) ///
(DDErrorrDELP_Mean2 DDErrorrIHME_Mean2 DDErrorrIMPE_Mean2 DDErrorrLANL_Mean2 DDErrorrSRIV_Mean2 DDErrorrUCLA_Mean2 DDErrorrYYGU_Mean2) 
