...
log using "log CovidLongitudinal Holy See 9 Merge.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Holy See 9 Merge.do"
...
** input data files: "`model' Holy See error.dta"

** output data files: "ALL MODELS Holy See error.dta" with all date
*                     "ALL MODELS Holy See error - only models across error measures.dta", replace
*                     "ALL MODELS Holy See error - only error measures across models.dta", replace

* output data dictionary files: "ALL MODELS Holy See error data dictionary.csv"
*                               "ALL MODELS Holy See error - only models across error measures data dictionary.csv"
*                               "ALL MODELS Holy See error - only error measures across models data dictionary.csv"


** Graphs:
* "graph 03 Holy See ALL MODELS C19 daily deaths error.pdf"
* "graph 04 Holy See ALL MODELS C19 daily deaths absolute error.pdf"
* "graph 05 Holy See ALL MODELS C19 daily deaths percent error.pdf"
* "graph 06 Holy See ALL MODELS C19 daily deaths absolute percent error.pdf"

* "graph 07a1 Holy See ALL MODELS C19 daily deaths average median error.pdf"
* "graph 07a2 Holy See ALL MODELS C19 daily deaths average median error smoothed.pdf"
* "graph 08a1 Holy See ALL MODELS C19 daily deaths average median absolute error.pdf"
* "graph 08a2 Holy See ALL MODELS C19 daily deaths average median absolute error smoothed.pdf"
* "graph 09a1 Holy See ALL MODELS C19 daily deaths average median percent error.pdf"
* "graph 09a2 Holy See ALL MODELS C19 daily deaths average median percent error smoothed.pdf"
* "graph 10a1 Holy See ALL MODELS C19 daily deaths average median absolute percent error.pdf"
* "graph 10a2 Holy See ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf"

****** graph each same error measure across models:
* "graph 12a Holy See ALL MODELS C19 daily deaths Average Mean Error.pdf"
* "graph 12b Holy See ALL MODELS C19 daily deaths Average Absolute Error.pdf"
* "graph 12c Holy See ALL MODELS C19 daily deaths Average Percent Error.pdf"
* "graph 12d Holy See ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf"

****** graph all models across error measures:
* "graph 13a Holy See ALL MODELS C19 daily deaths, models across error measures.pdf"

****** graph all error measures across models:
* "graph 13b Holy See ALL MODELS C19 daily deaths, error measures across models.pdf"
...
use "SRIV Holy See error.dta", clear 
	
	merge m:m date using "SRIV Holy See error.dta"	
...
subtitle("Holy See, all Models, all updates, forecast only", size(small)) ///
legend(position(6) order(1 "SRIV") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 03 Holy See ALL MODELS C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Holy See ALL MODELS C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Holy See ALL MODELS C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Holy See ALL MODELS C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Holy See, all Models, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
legend(position(6) order(1 "SRIV") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 07a1 Holy See ALL MODELS C19 daily deaths average median error.pdf", replace 
...
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths error measure) title("C19 daily deaths, average median error", size(medium) color(black)) /// 
subtitle("Holy See, all Models, forecast only; smoothed for better viewing", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
legend(position(6) order(1 "SRIV") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 07a2 Holy See ALL MODELS C19 daily deaths average median error smoothed.pdf", replace
...
qui graph export "graph 08a1 Holy See ALL MODELS C19 daily deaths average median absolute error.pdf", replace 
...
qui graph export "graph 08a2 Holy See ALL MODELS C19 daily deaths average median absolute error smoothed.pdf", replace
...
qui graph export "graph 09a1 Holy See ALL MODELS C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 09a2 Holy See ALL MODELS C19 daily deaths average median percent error smoothed.pdf", replace
...
qui graph export "graph 10a1 Holy See ALL MODELS C19 daily deaths average median absolute percent error.pdf", replace 
...
qui graph export "graph 10a2 Holy See ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf", replace
...
subtitle("Over updates and calendar months; forecast only; Holy See", size(small)) /// 
legend(region(lcolor(none))) legend(bexpand) ///
legend(position(6) order(1 "SRIV") size(small) row(1)) 

qui graph export "graph 12a Holy See ALL MODELS C19 daily deaths Average Mean Error.pdf", replace
...
qui graph export "graph 12b Holy See ALL MODELS C19 daily deaths Average Absolute Error.pdf", replace
...
qui graph export "graph 12c Holy See ALL MODELS C19 daily deaths Average Percent Error.pdf", replace
...
qui graph export "graph 12d Holy See ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf", replace
...
save "ALL MODELS Holy See error.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Holy See error data dictionary.csv", replace 
...
use "ALL MODELS Holy See error.dta", clear

save "ALL MODELS Holy See error - only models across error measures.dta", replace
...
save "CovidLongitudinal Holy See merge temp.dta", replace 
...
qui graph export "graph 13a Holy See ALL MODELS C19 daily deaths, models across error measures.pdf", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Holy See error - only models across error measures data dictionary.csv", replace 
...
use "CovidLongitudinal Holy See merge temp.dta", clear 
...
rename (DDErrorrSRIV) ///
       (DDA1E1) 
label var DDA1E1 "Daily Deaths Error mean of medians over updates and calendar months SRIV"

	   
rename (DDAbsErrSRIV) ///
       (DDA1E2) 
label var DDA1E2 "Daily Deaths Absolute Error mean of medians over updates and calendar months SRIV"
	   
rename (DDPerErrSRIV) ///
       (DDA1E3) 	   
label var DDA1E3 "Daily Deaths Percent Error mean of medians over updates and calendar months SRIV"

rename (DDAbPeErSRIV) ///
       (DDA1E4) 
label var DDA1E4 "Daily Deaths Absolute Percent Error mean of medians over updates and calendar months SRIV"
...
qui graph export "graph 13b Holy See ALL MODELS C19 daily deaths, error measures across models.pdf", replace
...
save "ALL MODELS Holy See error - only error measures across models.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Holy See error - only error measures across models data dictionary.csv", replace 
...
view "log CovidLongitudinal Holy See 9 Merge.smcl"
