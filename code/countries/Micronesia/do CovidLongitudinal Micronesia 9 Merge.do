...
log using "log CovidLongitudinal Micronesia 9 Merge.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Micronesia 9 Merge.do"
...
** input data files: "`model' Micronesia error.dta"

** output data files: "ALL MODELS Micronesia error.dta" with all date
*                     "ALL MODELS Micronesia error - only models across error measures.dta", replace
*                     "ALL MODELS Micronesia error - only error measures across models.dta", replace

* output data dictionary files: "ALL MODELS Micronesia error data dictionary.csv"
*                               "ALL MODELS Micronesia error - only models across error measures data dictionary.csv"
*                               "ALL MODELS Micronesia error - only error measures across models data dictionary.csv"


** Graphs:
* "graph 03 Micronesia ALL MODELS C19 daily deaths error.pdf"
* "graph 04 Micronesia ALL MODELS C19 daily deaths absolute error.pdf"
* "graph 05 Micronesia ALL MODELS C19 daily deaths percent error.pdf"
* "graph 06 Micronesia ALL MODELS C19 daily deaths absolute percent error.pdf"

* "graph 07a1 Micronesia ALL MODELS C19 daily deaths average median error.pdf"
* "graph 07a2 Micronesia ALL MODELS C19 daily deaths average median error smoothed.pdf"
* "graph 08a1 Micronesia ALL MODELS C19 daily deaths average median absolute error.pdf"
* "graph 08a2 Micronesia ALL MODELS C19 daily deaths average median absolute error smoothed.pdf"
* "graph 09a1 Micronesia ALL MODELS C19 daily deaths average median percent error.pdf"
* "graph 09a2 Micronesia ALL MODELS C19 daily deaths average median percent error smoothed.pdf"
* "graph 10a1 Micronesia ALL MODELS C19 daily deaths average median absolute percent error.pdf"
* "graph 10a2 Micronesia ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf"

****** graph each same error measure across models:
* "graph 12a Micronesia ALL MODELS C19 daily deaths Average Mean Error.pdf"
* "graph 12b Micronesia ALL MODELS C19 daily deaths Average Absolute Error.pdf"
* "graph 12c Micronesia ALL MODELS C19 daily deaths Average Percent Error.pdf"
* "graph 12d Micronesia ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf"

****** graph all models across error measures:
* "graph 13a Micronesia ALL MODELS C19 daily deaths, models across error measures.pdf"

****** graph all error measures across models:
* "graph 13b Micronesia ALL MODELS C19 daily deaths, error measures across models.pdf"
...
use "IMPE Micronesia error.dta", clear 
...
subtitle("Micronesia, all Models, all updates, forecast only", size(small)) ///
legend(position(6) order(1 "IMPE") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 03 Micronesia ALL MODELS C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Micronesia ALL MODELS C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Micronesia ALL MODELS C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Micronesia ALL MODELS C19 daily deaths absolute percent error.pdf", replace
...
save "ALL MODELS Micronesia error.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Micronesia error data dictionary.csv", replace 
...
use "ALL MODELS Micronesia error.dta", clear

save "ALL MODELS Micronesia error - only models across error measures.dta", replace
...
save "CovidLongitudinal Micronesia merge temp.dta", replace 
...
qui graph export "graph 13a Micronesia ALL MODELS C19 daily deaths, models across error measures.pdf", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Micronesia error - only models across error measures data dictionary.csv", replace 
...
use "CovidLongitudinal Micronesia merge temp.dta", clear 
...
save "ALL MODELS Micronesia error - only error measures across models.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Micronesia error - only error measures across models data dictionary.csv", replace 
...
view "log CovidLongitudinal Micronesia 9 Merge.smcl"
