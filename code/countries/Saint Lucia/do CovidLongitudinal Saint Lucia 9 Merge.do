...
use "IMPE Saint Lucia error.dta", clear 
	...
	merge m:m date using "SRIV Saint Lucia error.dta"	
...
legend(position(6) order(176 "IMPE" 305 "LANL" 1 "SRIV") ///
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
legend(position(6) order(1 "IMPE" 2 "LANL" 3 "SRIV") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand)
...
legend(position(6) order(1 "IMPE" 2 "LANL" 3 "SRIV") size(small) row(1)) 
...
rename ///
(DDErrorIMPE_Mean2 DDErrorLANL_Mean2 DDErrorSRIV_Mean2) ///
(DDErrorrIMPE_Mean2 DDErrorrLANL_Mean2 DDErrorrSRIV_Mean2) 
...
rename (DDErrorrIMPE DDErrorrLANL DDErrorrSRIV) ///
...
rename (DDAbsErrIMPE DDAbsErrLANL DDAbsErrSRIV) ///
...
rename (DDPerErrIMPE DDPerErrLANL DDPerErrSRIV) ///
...
rename (DDAbPeErIMPE DDAbPeErLANL DDAbPeErSRIV) ///
...
rename (DDA1E1 DDA2E1 DDA3E1) ///
       (DD_IMPE_Errorr DD_LANL_Errorr DD_SRIV_Errorr)
...
rename (DDA1E2 DDA2E2 DDA3E2) ///
       (DD_IMPE_AbsErr DD_LANL_AbsErr DD_SRIV_AbsErr)
...
rename (DDA1E3 DDA2E3 DDA3E3) ///
       (DD_IMPE_PerErr DD_LANL_PerErr DD_SRIV_PerErr)
...
(DD_IMPE_AbPeEr DD_LANL_AbPeEr DD_SRIV_AbPeEr)
