...
** graphs:
** "graph 2 Iran `model' C19 daily deaths all updates.pdf"
** "graph 2 Iran ALL MODELS C19 daily deaths all updates.pdf"
...
qui graph export "graph 2 Iran JOHN C19 daily deaths reported.pdf", replace
...
qui graph export "graph 2 Iran DELP C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	*/
	...
	// qui graph export "graph Iran 0 IHME daily deaths epoch `update'.pdf", replace
...
qui graph export "graph 2 Iran IHME C19 daily deaths all updates.pdf", replace
...
qui graph export "graph 2 Iran IMPE C19 daily deaths all updates.pdf", replace
...
qui graph export "graph 2 Iran LANL C19 daily deaths all updates.pdf", replace
...
qui graph export "graph 2 Iran SRIV C19 daily deaths all updates.pdf", replace
...
qui graph export "graph 2 Iran UCLA C19 daily deaths all updates.pdf", replace
...
qui graph export "graph 2 Iran YYGU C19 daily deaths all updates.pdf", replace
...
legend(order(1656 "JOHN" 15 "DELP" 172 "IHME" 107 "IMPE" 26 "LANL" 35 "SRIV" 616 "UCLA" 1 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 2 Iran ALL MODELS C19 daily deaths all updates.pdf", replace
