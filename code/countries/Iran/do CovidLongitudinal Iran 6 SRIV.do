...
** graphs:
* "graph 03 Iran SRIV C19 daily deaths error.pdf"
* "graph 04 Iran SRIV C19 daily deaths absolute error.pdf"
* "graph 05 Iran SRIV C19 daily deaths percent error.pdf"
* "graph 06 Iran SRIV C19 daily deaths absolute percent error.pdf"

* "graph 07 Iran SRIV C19 daily deaths average median error.pdf"
* "graph 08 Iran SRIV C19 daily deaths average median absolute error.pdf"
* "graph 09 Iran SRIV C19 daily deaths average median percent error.pdf"
* "graph 10 Iran SRIV C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Iran SRIV C19 daily deaths Average MAPE over updates and calendar months
...
qui replace DDErrorSRIV`update' = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Iran
                                                            // <<-- modify 3
...
qui replace DDAbsErrSRIV`update' = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Iran
...
qui replace DDPerErrSRIV`update' = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Iran
...
qui replace DDAbPeErSRIV`update' = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Iran
...
qui replace DDErrorSRIV`update'_Med1 = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Iran
...
qui replace DDAbsErrSRIV`update'_Med1 = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Iran
...
qui replace DDPerErrSRIV`update'_Med1 = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Iran
...
qui replace DDAbPeErSRIV`update'_Med1 = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Iran
...
qui replace DDErrorSRIV_Mean1 = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Iran
...
qui replace DDAbsErrSRIV_Mean1 = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Iran
...
qui replace DDPerErrSRIV_Mean1 = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Iran
...
qui replace DDAbPeErSRIV_Mean1 = . if date < td(02may2020) // 02may2020 is the earliest date of SRIV forecasts for Iran
...
qui graph export "graph 03 Iran SRIV C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Iran SRIV C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Iran SRIV C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Iran SRIV C19 daily deaths absolute percent error.pdf", replace
...
qui graph export "graph 07 Iran SRIV C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Iran SRIV C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Iran SRIV C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Iran SRIV C19 daily deaths average median absolute percent error.pdf", replace
...
qui graph export "graph 11 Iran SRIV C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
