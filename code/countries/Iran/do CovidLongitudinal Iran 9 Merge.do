...
log using "log CovidLongitudinal Iran 9.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Iran 9.do"
...
** Graphs:
* "graph 3 Iran ALL MODELS C19 daily deaths error.pdf"
* "graph 4 Iran ALL MODELS C19 daily deaths absolute error.pdf"
* "graph 5 Iran ALL MODELS C19 daily deaths percent error.pdf"
* "graph 6 Iran ALL MODELS C19 daily deaths absolute percent error.pdf"
* "graph 7 a Iran ALL MODELS C19 daily deaths average median error.pdf"
* "graph 7 b Iran ALL MODELS C19 daily deaths average median error smoothed.pdf"
* "graph 8 a Iran ALL MODELS C19 daily deaths average median absolute error.pdf"
* "graph 8 b Iran ALL MODELS C19 daily deaths average median absolute error smoothed.pdf"
* "graph 9 a Iran ALL MODELS C19 daily deaths average median percent error.pdf"
* "graph 9 b Iran ALL MODELS C19 daily deaths average median percent error smoothed.pdf"
* "graph 10 a Iran ALL MODELS C19 daily deaths average median absolute percent error.pdf"
* "graph 10 b Iran ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf"
****** graph each same error measure across models:
* "graph 11 a Iran ALL MODELS C19 daily deaths Average Mean Error.pdf"
* "graph 11 b Iran ALL MODELS C19 daily deaths Average Absolute Error.pdf"
* "graph 11 c Iran ALL MODELS C19 daily deaths Average Percent Error.pdf"
* "graph 11 d Iran ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf"
****** graph all models across error measures:
* "graph 12 a Iran ALL MODELS C19 daily deaths, models across error measures.pdf"
****** graph all error measures across models:
* "graph 12 b Iran ALL MODELS C19 daily deaths, error measures across models.pdf"
...
use "DELP Iran error.dta", clear 
	...
	merge m:m date using "SRIV Iran error.dta"	
...
legend(order(15 "DELP" 172 "IHME" 107 "IMPE" 26 "LANL" 35 "SRIV" 604 "UCLA" 1 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 3 Iran ALL MODELS C19 daily deaths error.pdf", replace
...
qui graph export "graph 4 Iran ALL MODELS C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 5 Iran ALL MODELS C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 6 Iran ALL MODELS C19 daily deaths absolute percent error.pdf", replace
...
qui graph export "graph 7 a Iran ALL MODELS C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 7 b Iran ALL MODELS C19 daily deaths average median error smoothed.pdf", replace
...
qui graph export "graph 8 a Iran ALL MODELS C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 8 b Iran ALL MODELS C19 daily deaths average median absolute error smoothed.pdf", replace
...
qui graph export "graph 9 a Iran ALL MODELS C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 9 b Iran ALL MODELS C19 daily deaths average median percent error smoothed.pdf", replace
...
qui graph export "graph 10 a Iran ALL MODELS C19 daily deaths average median absolute percent error.pdf", replace
...
qui graph export "graph 10 b Iran ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf", replace
...
qui graph export "graph 11 a Iran ALL MODELS C19 daily deaths Average Mean Error.pdf", replace
...
qui graph export "graph 11 b Iran ALL MODELS C19 daily deaths Average Absolute Error.pdf", replace
...
qui graph export "graph 11 c Iran ALL MODELS C19 daily deaths Average Percent Error.pdf", replace
...
qui graph export "graph 11 d Iran ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf", replace
...
qui graph export "graph 12 a Iran ALL MODELS C19 daily deaths, models across error measures.pdf", replace
...
qui graph export "graph 12 b Iran ALL MODELS C19 daily deaths, error measures across models.pdf", replace
...
view "log CovidLongitudinal Iran 9.smcl"
