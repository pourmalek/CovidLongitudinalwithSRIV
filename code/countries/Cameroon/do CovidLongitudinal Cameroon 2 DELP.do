...
log using "log CovidLongitudinal Cameroon 2 DELP.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Cameroon 2 DELP.do"
...
* input data files: "DELP Cameroon.dta"
* output data files: "DELP Cameroon error.dta" (with error measures saved)

* output data dictionary files: "DELP Cameroon error data dictionary.csv"
...
** graphs:
* "graph 03 Cameroon DELP C19 daily deaths error.pdf"
* "graph 04 Cameroon DELP C19 daily deaths absolute error.pdf"
* "graph 05 Cameroon DELP C19 daily deaths percent error.pdf"
* "graph 06 Cameroon DELP C19 daily deaths absolute percent error.pdf"

* "graph 07 Cameroon DELP C19 daily deaths average median error.pdf"
* "graph 08 Cameroon DELP C19 daily deaths average median absolute error.pdf"
* "graph 09 Cameroon DELP C19 daily deaths average median percent error.pdf"
* "graph 10 Cameroon DELP C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Cameroon DELP C19 daily deaths Average MAPE over updates and calendar months.pdf"
...
qui replace DDErrorDELP`update' = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Cameroon
                                                            // <<-- modify 3
...
qui replace DDAbsErrDELP`update' = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Cameroon
...
qui replace DDPerErrDELP`update' = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Cameroon
...
qui replace DDAbPeErDELP`update' = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Cameroon
...
qui replace DDErrorDELP`update'_Med1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Cameroon
...
qui replace DDAbsErrDELP`update'_Med1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Cameroon
...
qui replace DDPerErrDELP`update'_Med1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Cameroon
...
qui replace DDAbPeErDELP`update'_Med1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Cameroon
...
qui replace DDErrorDELP_Mean1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Cameroon
...
qui replace DDAbsErrDELP_Mean1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Cameroon
...
qui replace DDPerErrDELP_Mean1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Cameroon
...
qui replace DDAbPeErDELP_Mean1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Cameroon
...
subtitle("Cameroon, DELP, all updates, forecast only", size(small)) 

qui graph export "graph 03 Cameroon DELP C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Cameroon DELP C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Cameroon DELP C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Cameroon DELP C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Cameroon, DELP, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Cameroon DELP C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Cameroon DELP C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Cameroon DELP C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Cameroon DELP C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Cameroon, DELP, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Cameroon DELP C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "DELP Cameroon error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "DELP Cameroon error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Cameroon 2 DELP.smcl"
