...
log using "log CovidLongitudinal Cameroon 5 LANL.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Cameroon 5 LANL.do"
...
* input data files: "LANL Cameroon.dta"
* output data files: "LANL Cameroon error.dta" (with error measures saved)

* output data dictionary files: "LANL Cameroon error data dictionary.csv"
...
** graphs:
* "graph 03 Cameroon LANL C19 daily deaths error.pdf"
* "graph 04 Cameroon LANL C19 daily deaths absolute error.pdf"
* "graph 05 Cameroon LANL C19 daily deaths percent error.pdf"
* "graph 06 Cameroon LANL C19 daily deaths absolute percent error.pdf"

* "graph 07 Cameroon LANL C19 daily deaths average median error.pdf"
* "graph 08 Cameroon LANL C19 daily deaths average median absolute error.pdf"
* "graph 09 Cameroon LANL C19 daily deaths average median percent error.pdf"
* "graph 10 Cameroon LANL C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Cameroon LANL C19 daily deaths Average MAPE over updates and calendar months
...
qui replace DDErrorLANL`update' = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Cameroon
                                                            // <<-- modify 3
...
qui replace DDAbsErrLANL`update' = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Cameroon
...
qui replace DDPerErrLANL`update' = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Cameroon
...
qui replace DDAbPeErLANL`update' = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Cameroon
...
qui replace DDErrorLANL`update'_Med1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Cameroon
...
qui replace DDAbsErrLANL`update'_Med1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Cameroon
...
qui replace DDPerErrLANL`update'_Med1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Cameroon
...
qui replace DDAbPeErLANL`update'_Med1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Cameroon
...
qui replace DDErrorLANL_Mean1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Cameroon
...
qui replace DDAbsErrLANL_Mean1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Cameroon
...
qui replace DDPerErrLANL_Mean1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Cameroon
...
qui replace DDAbPeErLANL_Mean1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Cameroon
...
subtitle("Cameroon, LANL, all updates, forecast only", size(small)) 

qui graph export "graph 03 Cameroon LANL C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Cameroon LANL C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Cameroon LANL C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Cameroon LANL C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Cameroon, LANL, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Cameroon LANL C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Cameroon LANL C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Cameroon LANL C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Cameroon LANL C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Cameroon, LANL, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Cameroon LANL C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "LANL Cameroon error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "LANL Cameroon error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Cameroon 5 LANL.smcl"
