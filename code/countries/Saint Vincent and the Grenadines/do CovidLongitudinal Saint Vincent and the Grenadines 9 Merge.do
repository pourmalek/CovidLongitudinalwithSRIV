...
use "IMPE Saint Vincent and the Grenadines error.dta", clear 
	...
	merge m:m date using "SRIV Saint Vincent and the Grenadines error.dta"	
...
legend(position(6) order(176 "IMPE" 1 "SRIV") ///
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
legend(position(6) order(1 "IMPE" 2 "SRIV") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand)
...
bar(2, fcolor(green) lcolor(green)) ///
...
legend(position(6) order(1 "IMPE" 2 "SRIV") size(small) row(1)) 
...
rename ///
(DDErrorIMPE_Mean2 DDErrorSRIV_Mean2) ///
(DDErrorrIMPE_Mean2 DDErrorrSRIV_Mean2) 
...
rename (DDErrorrIMPE DDErrorrSRIV) ///
       (DDA1E1 DDA2E1) 
label var DDA1E1 "Daily Deaths Error mean of medians over updates and calendar months IMPE"
label var DDA2E1 "Daily Deaths Error mean of medians over updates and calendar months SRIV"

	   
rename (DDAbsErrIMPE DDAbsErrSRIV) ///
       (DDA1E2 DDA2E2) 
label var DDA1E2 "Daily Deaths Absolute Error mean of medians over updates and calendar months IMPE"
label var DDA2E2 "Daily Deaths Absolute Error mean of medians over updates and calendar months SRIV"
	   
rename (DDPerErrIMPE DDPerErrSRIV) ///
       (DDA1E3 DDA2E3) 	   
label var DDA1E3 "Daily Deaths Percent Error mean of medians over updates and calendar months IMPE"
label var DDA2E3 "Daily Deaths Percent Error mean of medians over updates and calendar months SRIV"

rename (DDAbPeErIMPE DDAbPeErSRIV) ///
       (DDA1E4 DDA2E4) 
label var DDA1E4 "Daily Deaths Absolute Percent Error mean of medians over updates and calendar months IMPE"
label var DDA2E4 "Daily Deaths Absolute Percent Error mean of medians over updates and calendar months SRIV"
