...
* Objective: Process the reported deaths by JOHN and 
	...
	* for each country ---->> United States of America / USA <<----                                                                 
***************************************************************************
...
** graphs:
** "graph 2 United States of America `model' C19 daily deaths all updates.pdf"
** "graph 2 United States of America ALL MODELS C19 daily deaths all updates.pdf"
...
foreach model of local list {
	...
	capture drop if provincestate != "US"
...
qui graph export "graph 2 United States of America JOHN C19 daily deaths reported.pdf", replace
...
foreach update of local list {
	...
	capture replace loc_grand_name = "United States of America" if loc_grand_name == "US" 
...
legend(order(1 "JOHN" 2 "DELP Forecast") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 2 United States of America DELP C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	*/
	...
	// qui graph export "graph United States of America 0 IHME daily deaths epoch `update'.pdf", replace
...
legend(order(1 "JOHN" 2 "IHME Forecast") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 2 United States of America IHME C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	capture replace loc_grand_name = "United States of America" if loc_grand_name == "United States"
...
legend(order(1 "JOHN" 2 "IMPE Forecast") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 2 United States of America IMPE C19 daily deaths all updates.pdf", replace
...
legend(order(1 "JOHN" 2 "LANL Forecast") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 2 United States of America LANL C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	capture { // some of the updates being used alread contain DayDeaMeRaSRIV, DayDeaMeSmSRIV, or DayDeaMeFoSRIV
	...
	* gen Daily deaths smooth forecast only 
	...
	capture label var DayDeaMeRaSRIV`update' "Daily deaths mean raw SRIV"
	...
	save "SRIV `update' United States of America.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "SRIV `update' United States of America.dta"
...
save "SRIV United States of America.dta", replace
...
preserve
    ...
    export delimited name varlab using "SRIV United States of America data dictionary.csv", replace 
...
* graph United States of America SRIV daily deaths all updates
...
(line DayDeaMeFoSRIV20210102 date, sort lwidth(thin) lcolor(green)) ///
...
(line DayDeaMeFoSRIV20210812 date, sort lwidth(thin) lcolor(green)) ///
...
(line DayDeaMeFoSRIV20211018 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20211019 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20211020 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20211021 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20211022 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20211023 date, sort lwidth(thin) lcolor(green)) ///
...
(line DayDeaMeFoSRIV20211113 date, sort lwidth(thin) lcolor(green)) ///
...
(line DayDeaMeFoSRIV20211123 date, sort lwidth(thin) lcolor(green)) ///
...
(line DayDeaMeFoSRIV20211206 date, sort lwidth(thin) lcolor(green)) ///
...
(line DayDeaMeFoSRIV20220412 date, sort lwidth(thin) lcolor(green)) ///
...
(line DayDeaMeFoSRIV20220523 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220524 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220525 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220526 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220527 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220528 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220529 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220530 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220531 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220601 date, sort lwidth(thin) lcolor(green)) ///
...
(line DayDeaMeFoSRIV20220729 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220730 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220731 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220801 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220802 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220803 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220804 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220805 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220806 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220807 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220808 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220809 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220810 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220811 date, sort lwidth(thin) lcolor(green)) ///
(line DayDeaMeFoSRIV20220812 date, sort lwidth(thin) lcolor(green)) ///
...
(line DayDeaMeFoSRIV20220912 date, sort lwidth(thin) lcolor(green)) ///
...
(line DayDeaMeFoSRIV20220915 date, sort lwidth(thin) lcolor(green)) ///
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small)) ylabel(, labsize(small) angle(forty_five)) ///
ytitle(Daily deaths) title("C19 daily deaths, United States of America, SRIV, all updates", size(medium) color(black)) ///
legend(order(1 "JOHN" 2 "SRIV Forecast") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 2 United States of America SRIV C19 daily deaths all updates.pdf", replace
...
legend(order(1 "JOHN" 2 "UCLA Forecast") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 2 United States of America UCLA C19 daily deaths all updates.pdf", replace
...
* group one of two of YYGU estimates for USA:
...
foreach update of local list {
	...
	di in red "This is : CovidLongitudinal YYGU USA " `update'

	use "CovidLongitudinal YYGU USA `update'.dta", clear
...
* group two of two of YYGU estimates for USA:
...
foreach update of local list {
	...
	di in red "This is : CovidLongitudinal YYGU _with_ USA " `update'
...
legend(order(1 "JOHN" 2 "YYGU Forecast") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 2 United States of America YYGU C19 daily deaths all updates.pdf", replace
...
legend(order(1732 "JOHN" 29 "DELP" 2 "IHME" 135 "IMPE" 43 "LANL" 55 "SRIV" 636 "UCLA" 1 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 2 United States of America ALL MODELS C19 daily deaths all updates.pdf", replace
