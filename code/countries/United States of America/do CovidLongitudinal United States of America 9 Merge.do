...
log using "log CovidLongitudinal United States of America 9.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal United States of America 9.do"
...
** Graphs:
* "graph 3 United States of America ALL MODELS C19 daily deaths error.pdf"
* "graph 4 United States of America ALL MODELS C19 daily deaths absolute error.pdf"
* "graph 5 United States of America ALL MODELS C19 daily deaths percent error.pdf"
* "graph 6 United States of America ALL MODELS C19 daily deaths absolute percent error.pdf"
* "graph 7 a United States of America ALL MODELS C19 daily deaths average median error.pdf"
* "graph 7 b United States of America ALL MODELS C19 daily deaths average median error smoothed.pdf"
* "graph 8 a United States of America ALL MODELS C19 daily deaths average median absolute error.pdf"
* "graph 8 b United States of America ALL MODELS C19 daily deaths average median absolute error smoothed.pdf"
* "graph 9 a United States of America ALL MODELS C19 daily deaths average median percent error.pdf"
* "graph 9 b United States of America ALL MODELS C19 daily deaths average median percent error smoothed.pdf"
* "graph 10 a United States of America ALL MODELS C19 daily deaths average median absolute percent error.pdf"
* "graph 10 b United States of America ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf"
****** graph each same error measure across models:
* "graph 11 a United States of America ALL MODELS C19 daily deaths Average Mean Error.pdf"
* "graph 11 b United States of America ALL MODELS C19 daily deaths Average Absolute Error.pdf"
* "graph 11 c United States of America ALL MODELS C19 daily deaths Average Percent Error.pdf"
* "graph 11 d United States of America ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf"
****** graph all models across error measures:
* "graph 12 a United States of America ALL MODELS C19 daily deaths, models across error measures.pdf"
****** graph all error measures across models:
* "graph 12 b United States of America ALL MODELS C19 daily deaths, error measures across models.pdf"
...
use "DELP United States of America error.dta", clear 
	...
	merge m:m date using "SRIV United States of America error.dta"	
...
******
* graph 3 Daily deaths, Error // <<-- modify 1
...
legend(order(29 "DELP" 1 "IHME" 135 "IMPE" 43 "LANL" 55 "SRIV" 636 "UCLA" 8 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 3 United States of America ALL MODELS C19 daily deaths error.pdf", replace
...
******
* graph 4 Daily deaths, AbsErr // <<-- modify 2
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%15.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths error measure) title("C19 C19 daily deaths absolute error", size(medium) color(black)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
subtitle("United States of America, all Models, all updates, Forecast only", size(small)) ///
legend(order(29 "DELP" 1 "IHME" 135 "IMPE" 43 "LANL" 55 "SRIV" 636 "UCLA" 8 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 4 United States of America ALL MODELS C19 daily deaths absolute error.pdf", replace
...
******
* graph 5 Daily deaths, Percent Error <<-- modify 3
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%15.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths error measure) title("C19 C19 daily deaths percent error", size(medium) color(black)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
subtitle("United States of America, all Models, all updates, Forecast only", size(small)) ///
legend(order(29 "DELP" 1 "IHME" 135 "IMPE" 43 "LANL" 55 "SRIV" 636 "UCLA" 8 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 5 United States of America ALL MODELS C19 daily deaths percent error.pdf", replace
...
******
* graph 6 Daily deaths, Absolute Percent Error // <<-- modify 4
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%15.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths error measure) title("C19 C19 daily deaths absolute percent error", size(medium) color(black)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
subtitle("United States of America, ALL MODELS, all updates, Forecast only", size(small)) ///
legend(order(29 "DELP" 1 "IHME" 135 "IMPE" 43 "LANL" 55 "SRIV" 636 "UCLA" 8 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 6 United States of America ALL MODELS C19 daily deaths absolute percent error.pdf", replace
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
legend(order(1 "DELP" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "SRIV" 6 "UCLA" 7 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 7 a United States of America ALL MODELS C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 7 b United States of America ALL MODELS C19 daily deaths average median error smoothed.pdf", replace
...
***************************************************************
* graph 8 a Daily deaths, average median absolute AbsErr 
...
qui graph export "graph 8 a United States of America ALL MODELS C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 8 b United States of America ALL MODELS C19 daily deaths average median absolute error smoothed.pdf", replace
...
qui graph export "graph 9 a United States of America ALL MODELS C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 9 b United States of America ALL MODELS C19 daily deaths average median percent error smoothed.pdf", replace
...
qui graph export "graph 10 a United States of America ALL MODELS C19 daily deaths average median absolute percent error.pdf", replace
...
qui graph export "graph 10 b United States of America ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf", replace
...
qui graph export "graph 11 a United States of America ALL MODELS C19 daily deaths Average Mean Error.pdf", replace
...
* graph 11 b Daily deaths, Avergae of Absolute Error over updates and calendar months
...
qui graph export "graph 11 b United States of America ALL MODELS C19 daily deaths Average Absolute Error.pdf", replace
...
* graph 11 c Daily deaths, Avergae of Percent PerErr over updates and calendar months
...
qui graph export "graph 11 c United States of America ALL MODELS C19 daily deaths Average Percent Error.pdf", replace
...
* graph 11 d Daily deaths, Avergae of Absolute Percent Error over updates and calendar months
...
qui graph export "graph 11 d United States of America ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf", replace
...
rename ///
(DDErrorDELP_Mean2str DDErrorIHME_Mean2str DDErrorIMPE_Mean2str DDErrorLANL_Mean2str DDErrorSRIV_Mean2str DDErrorUCLA_Mean2str DDErrorYYGU_Mean2str) ///
(DDErrorrDELP_Mean2str DDErrorrIHME_Mean2str DDErrorrIMPE_Mean2str DDErrorrLANL_Mean2str DDErrorrSRIV_Mean2str DDErrorrUCLA_Mean2str DDErrorrYYGU_Mean2str) 
...
replace model = "DELP" if model == "DELP_M"
replace model = "IHME" if model == "IHME_M"
replace model = "IMPE" if model == "IMPE_M"
replace model = "LANL" if model == "LANL_M"
replace model = "SRIV" if model == "SRIV_M"
replace model = "UCLA" if model == "UCLA_M"
replace model = "YYGU" if model == "YYGU_M"
...
qui graph export "graph 12 a United States of America ALL MODELS C19 daily deaths, models across error measures.pdf", replace
...
rename (DDErrorrDELP DDErrorrIHME DDErrorrIMPE DDErrorrLANL DDErrorrSRIV DDErrorrUCLA DDErrorrYYGU) ///
       (DDA1E1 DDA2E1 DDA3E1 DDA4E1 DDA5E1 DDA6E1 DDA7E1) 
...
label var DDA6E1 "Daily Deaths Error mean of medians over updates and calendar months UCLA"
label var DDA7E1 "Daily Deaths Error mean of medians over updates and calendar months YYGU"

	   
rename (DDAbsErrDELP DDAbsErrIHME DDAbsErrIMPE DDAbsErrLANL DDAbsErrSRIV DDAbsErrUCLA DDAbsErrYYGU) ///
       (DDA1E2 DDA2E2 DDA3E2 DDA4E2 DDA5E2 DDA6E2 DDA7E2) 
...
label var DDA6E2 "Daily Deaths Absolute Error mean of medians over updates and calendar months UCLA"
label var DDA7E2 "Daily Deaths Absolute Error mean of medians over updates and calendar months YYGU"	   
	   
rename (DDPerErrDELP DDPerErrIHME DDPerErrIMPE DDPerErrLANL DDPerErrSRIV DDPerErrUCLA DDPerErrYYGU) ///
       (DDA1E3 DDA2E3 DDA3E3 DDA4E3 DDA5E3 DDA6E3 DDA7E3) 	   
...
label var DDA6E3 "Daily Deaths Percent Error mean of medians over updates and calendar months UCLA"
label var DDA7E3 "Daily Deaths Percent Error mean of medians over updates and calendar months YYGU"

rename (DDAbPeErDELP DDAbPeErIHME DDAbPeErIMPE DDAbPeErLANL DDAbPeErSRIV DDAbPeErUCLA DDAbPeErYYGU) ///
       (DDA1E4 DDA2E4 DDA3E4 DDA4E4 DDA5E4 DDA6E4 DDA7E4) 
...
label var DDA6E4 "Daily Deaths Absolute Percent Error mean of medians over updates and calendar months UCLA"
label var DDA7E4 "Daily Deaths Absolute Percent Error mean of medians over updates and calendar months YYGU"

	   
reshape long DDA1 DDA2 DDA3 DDA4 DDA5 DDA6 DDA7, i(i) j(E, string)
...
graph bar DDA1 DDA2 DDA3 DDA4 DDA5 DDA6 DDA7, over(type) ///
bar(1, fcolor(red) lcolor(red)) ///
bar(2, fcolor(black) lcolor(black)) ///
bar(3, fcolor(magenta) lcolor(magenta)) ///
bar(4, fcolor(brown) lcolor(brown)) ///
...
qui graph export "graph 12 b United States of America ALL MODELS C19 daily deaths, error measures across models.pdf", replace
...
view "log CovidLongitudinal United States of America 9.smcl"
