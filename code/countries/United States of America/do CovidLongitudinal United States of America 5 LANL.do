...
** graphs:
* "graph 3 United States of America LANL C19 daily deaths error.pdf"
* "graph 4 United States of America LANL C19 daily deaths absolute error.pdf"
* "graph 5 United States of America LANL C19 daily deaths percent error.pdf"
* "graph 6 United States of America LANL C19 daily deaths absolute percent error.pdf"
* "graph 7 a United States of America LANL C19 daily deaths average median error.pdf"
* "graph 7 b United States of America LANL C19 daily deaths average median error smoothed.pdf"
* "graph 8 a United States of America LANL C19 daily deaths average median absolute error.pdf"
* "graph 8 b United States of America LANL C19 daily deaths average median absolute error smoothed.pdf"
* "graph 9 a United States of America LANL C19 daily deaths average median percent error.pdf"
* "graph 9 b United States of America LANL C19 daily deaths average median percent error smoothed.pdf"
* "graph 10 a United States of America LANL C19 daily deaths average median absolute percent error.pdf"
* "graph 10 b United States of America LANL C19 daily deaths average median absolute percent error smoothed.pdf"
* "graph 11 United States of America LANL C19 daily deaths average Median Absolute Percent Error.pdf"
...
qui replace DDErrorLANL`update' = . if date < td(09Mar2020) // 09Mar2020 is the earliest date of LANL Forecasts for United States of America
                                                            // <<-- modify 3
...
qui replace DDAbsErrLANL`update' = . if date < td(09Mar2020) // 09Mar2020 is the earliest date of LANL Forecasts for United States of America
...
qui replace DDPerErrLANL`update' = . if date < td(09Mar2020) // 09Mar2020 is the earliest date of LANL Forecasts for United States of America
...
qui replace DDAbPeErLANL`update' = . if date < td(09Mar2020) // 09Mar2020 is the earliest date of LANL Forecasts for United States of America
...
qui replace DDErrorLANL`update'_Med1 = . if date < td(09Mar2020) // 09Mar2020 is the earliest date of LANL Forecasts for United States of America
...
qui replace DDAbsErrLANL`update'_Med1 = . if date < td(09Mar2020) // 09Mar2020 is the earliest date of LANL Forecasts for United States of America
...
qui replace DDPerErrLANL`update'_Med1 = . if date < td(09Mar2020) // 09Mar2020 is the earliest date of LANL Forecasts for United States of America
...
qui replace DDAbPeErLANL`update'_Med1 = . if date < td(09Mar2020) // 09Mar2020 is the earliest date of LANL Forecasts for United States of America
...
qui replace DDErrorLANL_Mean1 = . if date < td(09Mar2020) // 09Mar2020 is the earliest date of LANL Forecasts for United States of America
...
qui replace DDAbsErrLANL_Mean1 = . if date < td(09Mar2020) // 09Mar2020 is the earliest date of LANL Forecasts for United States of America
...
qui replace DDPerErrLANL_Mean1 = . if date < td(09Mar2020) // 09Mar2020 is the earliest date of LANL Forecasts for United States of America
...
qui replace DDAbPeErLANL_Mean1 = . if date < td(09Mar2020) // 09Mar2020 is the earliest date of LANL Forecasts for United States of America
...
qui graph export "graph 3 United States of America LANL C19 daily deaths error.pdf", replace
...
qui graph export "graph 4 United States of America LANL C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 5 United States of America LANL C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 6 United States of America LANL C19 daily deaths absolute percent error.pdf", replace
...
qui graph export "graph 7 a United States of America LANL C19 daily deaths average median error.pdf", replace
...
xlabel(, angle(forty_five)) ylabel(, format(%15.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths error measure) title("C19 daily deaths, average median error", size(medium) color(black)) /// 
subtitle("United States of America, LANL, Forecast only; smoothed for better viewing", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 7 b United States of America LANL C19 daily deaths average median error smoothed.pdf", replace
...
qui graph export "graph 8 a United States of America LANL C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 8 b United States of America LANL C19 daily deaths average median absolute error smoothed.pdf", replace
...
qui graph export "graph 9 a United States of America LANL C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 9 b United States of America LANL C19 daily deaths average median percent error smoothed.pdf", replace
...
qui graph export "graph 10 a United States of America LANL C19 daily deaths average median absolute percent error.pdf", replace
...
qui graph export "graph 10 b United States of America LANL C19 daily deaths average median absolute percent error smoothed.pdf", replace
...
qui graph export "graph 11 United States of America LANL C19 daily deaths average Median Absolute Percent Error.pdf", replace
