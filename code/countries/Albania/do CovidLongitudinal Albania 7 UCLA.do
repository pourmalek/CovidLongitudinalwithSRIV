...
log using "log CovidLongitudinal Albania 7 UCLA.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Albania 7 UCLA.do"
...
* input data files: "UCLA Albania.dta"
* output data files: "UCLA Albania error.dta" (with error measures saved)

* output data dictionary files: "UCLA Albania error data dictionary.csv"
...
** graphs:
* "graph 3 Albania UCLA C19 daily deaths error.pdf"
* "graph 4 Albania UCLA C19 daily deaths absolute error.pdf"
* "graph 5 Albania UCLA C19 daily deaths percent error.pdf"
* "graph 6 Albania UCLA C19 daily deaths absolute percent error.pdf"
* "graph 7 a Albania UCLA C19 daily deaths average median error.pdf"
* "graph 7 b Albania UCLA C19 daily deaths average median error smoothed.pdf"
* "graph 8 a Albania UCLA C19 daily deaths average median absolute error.pdf"
* "graph 8 b Albania UCLA C19 daily deaths average median absolute error smoothed.pdf"
* "graph 9 a Albania UCLA C19 daily deaths average median percent error.pdf"
* "graph 9 b Albania UCLA C19 daily deaths average median percent error smoothed.pdf"
* "graph 10 a Albania UCLA C19 daily deaths average median absolute percent error.pdf"
* "graph 10 b Albania UCLA C19 daily deaths average median absolute percent error smoothed.pdf"
* "graph 11 Albania UCLA C19 daily deaths average Median Absolute Percent Error.pdf"
...
qui replace DDErrorUCLA`update' = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Albania
                                                            // <<-- modify 3
...
qui replace DDAbsErrUCLA`update' = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Albania
...
qui replace DDPerErrUCLA`update' = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Albania
...
qui replace DDAbPeErUCLA`update' = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Albania
...
qui replace DDErrorUCLA`update'_Med1 = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Albania
...
qui replace DDAbsErrUCLA`update'_Med1 = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Albania
...
qui replace DDPerErrUCLA`update'_Med1 = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Albania
...
qui replace DDAbPeErUCLA`update'_Med1 = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Albania
...
qui replace DDErrorUCLA_Mean1 = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Albania
...
qui replace DDAbsErrUCLA_Mean1 = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Albania
...
qui replace DDPerErrUCLA_Mean1 = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Albania
...
qui replace DDAbPeErUCLA_Mean1 = . if date < td(03Jan2021) // 03Jan2021 is the earliest date of UCLA Forecasts for Albania
...
subtitle("Albania, UCLA, all updates, Forecast only", size(small)) 

qui graph export "graph 3 Albania UCLA C19 daily deaths error.pdf", replace
...
qui graph export "graph 4 Albania UCLA C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 5 Albania UCLA C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 6 Albania UCLA C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Albania, UCLA, Forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 7 a Albania UCLA C19 daily deaths average median error.pdf", replace
...
xlabel(, angle(forty_five)) ylabel(, format(%15.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths error measure) title("C19 daily deaths, average median error", size(medium) color(black)) /// 
subtitle("Albania, UCLA, Forecast only; smoothed for better viewing", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 7 b Albania UCLA C19 daily deaths average median error smoothed.pdf", replace
...
qui graph export "graph 8 a Albania UCLA C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 8 b Albania UCLA C19 daily deaths average median absolute error smoothed.pdf", replace
...
qui graph export "graph 9 a Albania UCLA C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 9 b Albania UCLA C19 daily deaths average median percent error smoothed.pdf", replace
...
qui graph export "graph 10 a Albania UCLA C19 daily deaths average median absolute percent error.pdf", replace
...
qui graph export "graph 10 b Albania UCLA C19 daily deaths average median absolute percent error smoothed.pdf", replace
...
subtitle("Albania, UCLA, Forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) 

qui graph export "graph 11 Albania UCLA C19 daily deaths average Median Absolute Percent Error.pdf", replace
...
save "UCLA Albania error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "UCLA Albania error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Albania 7 UCLA.smcl"
