...
log using "log CovidLongitudinal Albania 9.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Albania 9.do"
...
** Graphs:
* "graph 3 Albania ALL MODELS C19 daily deaths error.pdf"
* "graph 4 Albania ALL MODELS C19 daily deaths absolute error.pdf"
* "graph 5 Albania ALL MODELS C19 daily deaths percent error.pdf"
* "graph 6 Albania ALL MODELS C19 daily deaths absolute percent error.pdf"
* "graph 7 a Albania ALL MODELS C19 daily deaths average median error.pdf"
* "graph 7 b Albania ALL MODELS C19 daily deaths average median error smoothed.pdf"
* "graph 8 a Albania ALL MODELS C19 daily deaths average median absolute error.pdf"
* "graph 8 b Albania ALL MODELS C19 daily deaths average median absolute error smoothed.pdf"
* "graph 9 a Albania ALL MODELS C19 daily deaths average median percent error.pdf"
* "graph 9 b Albania ALL MODELS C19 daily deaths average median percent error smoothed.pdf"
* "graph 10 a Albania ALL MODELS C19 daily deaths average median absolute percent error.pdf"
* "graph 10 b Albania ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf"
****** graph each same error measure across models:
* "graph 11 a Albania ALL MODELS C19 daily deaths Average Mean Error.pdf"
* "graph 11 b Albania ALL MODELS C19 daily deaths Average Absolute Error.pdf"
* "graph 11 c Albania ALL MODELS C19 daily deaths Average Percent Error.pdf"
* "graph 11 d Albania ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf"
****** graph all models across error measures:
* "graph 12 a Albania ALL MODELS C19 daily deaths, models across error measures.pdf"
****** graph all error measures across models:
* "graph 12 b Albania ALL MODELS C19 daily deaths, error measures across models.pdf"
...
use "DELP Albania error.dta", clear 
	...
	merge m:m date using "SRIV Albania error.dta"	

	drop _merge
	
	/* --->>> Albania not included in UCLA and YYGU
	
	merge m:m date using "UCLA Albania error.dta", force
	
	drop _merge
	
	merge m:m date using "YYGU Albania error.dta", force	
...
legend(order(1 "DELP" 127 "IHME" 4 "IMPE" 3 "LANL" 11 "SRIV") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 3 Albania ALL MODELS C19 daily deaths error.pdf", replace
...
qui graph export "graph 4 Albania ALL MODELS C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 5 Albania ALL MODELS C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 6 Albania ALL MODELS C19 daily deaths absolute percent error.pdf", replace
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
legend(order(1 "DELP" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "SRIV") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 7 a Albania ALL MODELS C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 7 b Albania ALL MODELS C19 daily deaths average median error smoothed.pdf", replace
...
qui graph export "graph 8 a Albania ALL MODELS C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 8 b Albania ALL MODELS C19 daily deaths average median absolute error smoothed.pdf", replace
...
qui graph export "graph 9 a Albania ALL MODELS C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 9 b Albania ALL MODELS C19 daily deaths average median percent error smoothed.pdf", replace
...
qui graph export "graph 10 a Albania ALL MODELS C19 daily deaths average median absolute percent error.pdf", replace
...
qui graph export "graph 10 b Albania ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf", replace
...
legend(order(1 "DELP" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "SRIV") size(small) row(2)) 

qui graph export "graph 11 a Albania ALL MODELS C19 daily deaths Average Mean Error.pdf", replace
...
qui graph export "graph 11 b Albania ALL MODELS C19 daily deaths Average Absolute Error.pdf", replace
...
qui graph export "graph 11 c Albania ALL MODELS C19 daily deaths Average Percent Error.pdf", replace
...
qui graph export "graph 11 d Albania ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf", replace
...
rename ///
(DDErrorDELP_Mean2str DDErrorIHME_Mean2str DDErrorIMPE_Mean2str DDErrorLANL_Mean2str DDErrorSRIV_Mean2str) ///
(DDErrorrDELP_Mean2str DDErrorrIHME_Mean2str DDErrorrIMPE_Mean2str DDErrorrLANL_Mean2str DDErrorrSRIV_Mean2str) 
...
qui graph export "graph 12 a Albania ALL MODELS C19 daily deaths, models across error measures.pdf", replace
...
view "log CovidLongitudinal Albania 9.smcl"
