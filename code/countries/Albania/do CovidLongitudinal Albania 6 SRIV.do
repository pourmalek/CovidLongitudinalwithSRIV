...
log using "log CovidLongitudinal Albania 6 SRIV.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Albania 6 SRIV.do"
...
* input data files: "SRIV Albania.dta"
* output data files: "SRIV Albania error.dta" (with error measures saved)

* output data dictionary files: "SRIV Albania error data dictionary.csv"
...
** graphs:
* "graph 3 Albania SRIV C19 daily deaths error.pdf"
* "graph 4 Albania SRIV C19 daily deaths absolute error.pdf"
* "graph 5 Albania SRIV C19 daily deaths percent error.pdf"
* "graph 6 Albania SRIV C19 daily deaths absolute percent error.pdf"
* "graph 7 a Albania SRIV C19 daily deaths average median error.pdf"
* "graph 7 b Albania SRIV C19 daily deaths average median error smoothed.pdf"
* "graph 8 a Albania SRIV C19 daily deaths average median absolute error.pdf"
* "graph 8 b Albania SRIV C19 daily deaths average median absolute error smoothed.pdf"
* "graph 9 a Albania SRIV C19 daily deaths average median percent error.pdf"
* "graph 9 b Albania SRIV C19 daily deaths average median percent error smoothed.pdf"
* "graph 10 a Albania SRIV C19 daily deaths average median absolute percent error.pdf"
* "graph 10 b Albania SRIV C19 daily deaths average median absolute percent error smoothed.pdf"
* "graph 11 Albania SRIV C19 daily deaths average Median Absolute Percent Error.pdf"
...
qui replace DDErrorSRIV`update' = . if date < td(02May2020) // 02May2020 is the earliest date of SRIV Forecasts for Albania
                                                            // <<-- modify 3
...
qui replace DDAbsErrSRIV`update' = . if date < td(02May2020) // 02May2020 is the earliest date of SRIV Forecasts for Albania
...
qui replace DDPerErrSRIV`update' = . if date < td(02May2020) // 02May2020 is the earliest date of SRIV Forecasts for Albania
...
qui replace DDAbPeErSRIV`update' = . if date < td(02May2020) // 02May2020 is the earliest date of SRIV Forecasts for Albania
...
qui replace DDErrorSRIV`update'_Med1 = . if date < td(02May2020) // 02May2020 is the earliest date of SRIV Forecasts for Albania
...
qui replace DDAbsErrSRIV`update'_Med1 = . if date < td(02May2020) // 02May2020 is the earliest date of SRIV Forecasts for Albania
...
qui replace DDPerErrSRIV`update'_Med1 = . if date < td(02May2020) // 02May2020 is the earliest date of SRIV Forecasts for Albania
...
qui replace DDAbPeErSRIV`update'_Med1 = . if date < td(02May2020) // 02May2020 is the earliest date of SRIV Forecasts for Albania
...
qui replace DDErrorSRIV_Mean1 = . if date < td(02May2020) // 02May2020 is the earliest date of SRIV Forecasts for Albania
...
qui replace DDAbsErrSRIV_Mean1 = . if date < td(02May2020) // 02May2020 is the earliest date of SRIV Forecasts for Albania
...
qui replace DDPerErrSRIV_Mean1 = . if date < td(02May2020) // 02May2020 is the earliest date of SRIV Forecasts for Albania
...
qui replace DDAbPeErSRIV_Mean1 = . if date < td(02May2020) // 02May2020 is the earliest date of SRIV Forecasts for Albania
...
subtitle("Albania, SRIV, all updates, Forecast only", size(small)) 

qui graph export "graph 3 Albania SRIV C19 daily deaths error.pdf", replace
...
qui graph export "graph 4 Albania SRIV C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 5 Albania SRIV C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 6 Albania SRIV C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Albania, SRIV, Forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 7 a Albania SRIV C19 daily deaths average median error.pdf", replace
...
xlabel(, angle(forty_five)) ylabel(, format(%15.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths error measure) title("C19 daily deaths, average median error", size(medium) color(black)) /// 
subtitle("Albania, SRIV, Forecast only; smoothed for better viewing", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 7 b Albania SRIV C19 daily deaths average median error smoothed.pdf", replace
...
qui graph export "graph 8 a Albania SRIV C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 8 b Albania SRIV C19 daily deaths average median absolute error smoothed.pdf", replace
...
qui graph export "graph 9 a Albania SRIV C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 9 b Albania SRIV C19 daily deaths average median percent error smoothed.pdf", replace
...
qui graph export "graph 10 a Albania SRIV C19 daily deaths average median absolute percent error.pdf", replace
...
qui graph export "graph 10 b Albania SRIV C19 daily deaths average median absolute percent error smoothed.pdf", replace
...
subtitle("Albania, SRIV, Forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) 

qui graph export "graph 11 Albania SRIV C19 daily deaths average Median Absolute Percent Error.pdf", replace
...
save "SRIV Albania error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "SRIV Albania error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Albania 6 SRIV.smcl"
