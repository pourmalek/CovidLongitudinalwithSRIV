...
use "DELP Slovenia error.dta", clear 
	...
	merge m:m date using "SRIV Slovenia error.dta"	
...
legend(position(6) order(15 "DELP" 1 "IHME" 126 "IMPE" 29 "LANL" 41 "SRIV" 2 "YYGU") ///
...
graph bar DDA1 DDA2 DDA3 DDA4 DDA5 DDA6 DDA6, over(type) ///
bar(1, fcolor(red) lcolor(red)) ///
bar(2, fcolor(black) lcolor(black)) ///
bar(3, fcolor(magenta) lcolor(magenta)) ///
bar(4, fcolor(brown) lcolor(brown)) ///
