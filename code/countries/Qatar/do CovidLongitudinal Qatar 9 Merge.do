...
use "DELP Qatar error.dta", clear 
	...
	merge m:m date using "SRIV Qatar error.dta"	
...
legend(position(6) order(1 "DELP" 82 "IHME" 41 "IMPE" 29 "LANL" 4 "SRIV" 410 "UCLA") ///
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
legend(position(6) order(1 "DELP" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "SRIV" 6 "UCLA") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand)
...
legend(position(6) order(1 "DELP" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "SRIV" 6 "UCLA") size(small) row(2)) 
...
rename ///
(DDErrorDELP_Mean2 DDErrorIHME_Mean2 DDErrorIMPE_Mean2 DDErrorLANL_Mean2 DDErrorSRIV_Mean2 DDErrorUCLA_Mean2) ///
(DDErrorrDELP_Mean2 DDErrorrIHME_Mean2 DDErrorrIMPE_Mean2 DDErrorrLANL_Mean2 DDErrorrSRIV_Mean2 DDErrorrUCLA_Mean2) 
...
rename (DDErrorrDELP DDErrorrIHME DDErrorrIMPE DDErrorrLANL DDErrorrSRIV DDErrorrUCLA) ///
...
rename (DDAbsErrDELP DDAbsErrIHME DDAbsErrIMPE DDAbsErrLANL DDAbsErrSRIV DDAbsErrUCLA) ///
...
rename (DDPerErrDELP DDPerErrIHME DDPerErrIMPE DDPerErrLANL DDPerErrSRIV DDPerErrUCLA) ///
...
rename (DDAbPeErDELP DDAbPeErIHME DDAbPeErIMPE DDAbPeErLANL DDAbPeErSRIV DDAbPeErUCLA) ///
...
rename (DDA1E1 DDA2E1 DDA3E1 DDA4E1 DDA5E1 DDA6E1) ///
       (DD_DELP_Errorr DD_IHME_Errorr DD_IMPE_Errorr DD_LANL_Errorr DD_SRIV_Errorr DD_UCLA_Errorr)
...
rename (DDA1E2 DDA2E2 DDA3E2 DDA4E2 DDA5E2 DDA6E2) ///
       (DD_DELP_AbsErr DD_IHME_AbsErr DD_IMPE_AbsErr DD_LANL_AbsErr DD_SRIV_AbsErr DD_UCLA_AbsErr)
...
rename (DDA1E3 DDA2E3 DDA3E3 DDA4E3 DDA5E3 DDA6E3) ///
       (DD_DELP_PerErr DD_IHME_PerErr DD_IMPE_PerErr DD_LANL_PerErr DD_SRIV_PerErr DD_UCLA_PerErr)
...
(DD_DELP_AbPeEr DD_IHME_AbPeEr DD_IMPE_AbPeEr DD_LANL_AbPeEr DD_SRIV_AbPeEr DD_UCLA_AbPeEr)
